...
object ArticleXyyPlus {
  def miaomiaomiao1[T0 <: EatXyyType0, T1 <: org.scalax.asuna.mapper.TypeParam]: org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] =
    new org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] {
      override def plus(p: T0#H, item: T1#H): XyyItem1[T1#H]                        = HListItem0.eat(item)
      override def takeHead(t: XyyItem1[T1#H]): T1#H                                = t.i1
      override def takeTail(t: XyyItem1[T1#H]): T0#H                                = HListItem0
  ...
  def miaomiaomiao2[T0 <: EatXyyType0, T1 <: org.scalax.asuna.mapper.TypeParam]: org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] =
    new org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] {
      override def plus(p: T0#H, item: T1#H): XyyItem1[T1#H]                        = ReverseHListItem0.pudao(item)
      override def takeHead(t: XyyItem1[T1#H]): T1#H                                = t.i1
      override def takeTail(t: XyyItem1[T1#H]): T0#H                                = ReverseHListItem0
  ...
  def miaomiaomiao3[T0 <: EatXyyType0, T1 <: org.scalax.asuna.mapper.TypeParam]: org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] =
    new org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] {
      override def plus(p: T0#H, item: T1#H): XyyItem1[T1#H]                        = TreeItem0.eat(item)
      override def takeHead(t: XyyItem1[T1#H]): T1#H                                = t.i1
      override def takeTail(t: XyyItem1[T1#H]): T0#H                                = TreeItem0
  ...
  def miaomiaomiao4[T0 <: EatXyyType0, T1 <: org.scalax.asuna.mapper.TypeParam]: org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] =
    new org.scalax.asuna.mapper.Plus[T0, T1, EatXyyType1[T1]] {
      override def plus(p: T0#H, item: T1#H): XyyItem1[T1#H]                        = ReverseTreeItem0.pudao(item)
      override def takeHead(t: XyyItem1[T1#H]): T1#H                                = t.i1
      override def takeTail(t: XyyItem1[T1#H]): T0#H                                = ReverseTreeItem0
