...
import shapeless._
class ReverseHListItem6[E1, E2, E3, E4, E5, E6](val head: E1 :: E2 :: E3 :: E4 :: E5 :: E6 :: HNil) extends AnyVal with XyyItem6[E1, E2, E3, E4, E5, E6] {
  override def pudao[T](xyy: T): ReverseHListItem7[T, E1, E2, E3, E4, E5, E6] = new ReverseHListItem7[T, E1, E2, E3, E4, E5, E6](xyy :: head)
