...
trait Item13[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13] extends Any {
  self =>
  def i1: E1
  def i2: E2
  def i3: E3
  ...
  def leftTail: Item12[E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13]                = throw new Exception("Can not use this method.")
  def rightHead: E13                                                                      = throw new Exception("Can not use this method.")
  def rightTail: Item12[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12]                = throw new Exception("Can not use this method.")
  def eat[T](xyy: T): Item14[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, T]   = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item14[T, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13] = throw new Exception("Can not use this method.")
