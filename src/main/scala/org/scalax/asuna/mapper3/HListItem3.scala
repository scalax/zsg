...
import shapeless._
class HListItem3[E1, E2, E3](val head: E3 :: E2 :: E1 :: HNil) extends AnyVal with XyyItem3[E1, E2, E3] {
  override def eat[T](xyy: T): HListItem4[E1, E2, E3, T] = new HListItem4[E1, E2, E3, T](xyy :: head)
