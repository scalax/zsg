...
object ItemTagWithMessage16 {
  implicit def appendEatXyy16[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage16[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage16[
      H1,
      Message1,
      H2,
      Message2,
