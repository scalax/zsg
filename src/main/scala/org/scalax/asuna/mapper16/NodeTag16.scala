...
class NodeTag16[
  ...
  override type XyyItemType = Item16[
    T1#XyyItemType,
    T2#XyyItemType,
    T3#XyyItemType,
    T4#XyyItemType,
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag16[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag16[
    T1,
    M1,
    T2,
    M2,
...
object NodeTag16 {
  implicit def appendNodeTagEatXyy16[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag16[
      H1,
      M1,
      H2,
      M2,
...
class `Please change .debug(context) to .find16.debug(context).` extends org.scalax.asuna.mapper.item.Message
