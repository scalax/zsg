...
class TreeItem9[T1, T2, T3, T4, T5, T6, T7, T8, T9](
...
class ReverseTreeItem9[T1, T2, T3, T4, T5, T6, T7, T8, T9](
  ...
  override def leftTail: ReverseTreeItem8[T2, T3, T4, T5, T6, T7, T8, T9] = new ReverseTreeItem8(item.dropRight)
