...
object ItemTagWithMessage9 {
  implicit def appendEatXyy9[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage9[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage9[
      H1,
      Message1,
      H2,
      Message2,
