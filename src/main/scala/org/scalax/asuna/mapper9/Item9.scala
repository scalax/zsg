...
trait Item9[E1, E2, E3, E4, E5, E6, E7, E8, E9] extends Any {
  self =>
  def i1: E1
  def i2: E2
  def i3: E3
  ...
  def leftTail: Item8[E2, E3, E4, E5, E6, E7, E8, E9]                         = throw new Exception("Can not use this method.")
  def rightHead: E9                                                           = throw new Exception("Can not use this method.")
  def rightTail: Item8[E1, E2, E3, E4, E5, E6, E7, E8]                        = throw new Exception("Can not use this method.")
  def eat[T](xyy: T): Item10[E1, E2, E3, E4, E5, E6, E7, E8, E9, T]           = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item10[T, E1, E2, E3, E4, E5, E6, E7, E8, E9]         = throw new Exception("Can not use this method.")
