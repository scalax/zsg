...
class ItemTag9[
  ...
  override type XyyItemType = Item9[T1, T2, T3, T4, T5, T6, T7, T8, T9]
  override type M[M <: org.scalax.asuna.mapper.item.Message] =
    ItemTag9[T1, M :-<>-: M1, T2, M :-<>-: M2, T3, M :-<>-: M3, T4, M :-<>-: M4, T5, M :-<>-: M5, T6, M :-<>-: M6, T7, M :-<>-: M7, T8, M :-<>-: M8, T9, M :-<>-: M9]
  def debug[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag9[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7, T8, M8, T9, M9], EatXyyType9[
    I1,
    I2,
    I3,
    I4,
...
object ItemTag9 {
  implicit def appendEatXyy9[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag9[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8, H9, M9], EatXyyType9[
    T1,
    T2,
    T3,
    T4,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag9[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8, H9, M9], EatXyyType9[
      T1,
      T2,
      T3,
      T4,
