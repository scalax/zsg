...
object ItemTag5 {
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag5[H1, H2, H3, H4, H5], EatXyyType5[T1, T2, T3, T4, T5]] =
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag5[H1, H2, H3, H4, H5], EatXyyType5[T1, T2, T3, T4, T5]] {
