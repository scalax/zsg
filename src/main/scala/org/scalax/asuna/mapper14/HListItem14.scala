...
import shapeless._
class HListItem14[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14](
  val head: E14 :: E13 :: E12 :: E11 :: E10 :: E9 :: E8 :: E7 :: E6 :: E5 :: E4 :: E3 :: E2 :: E1 :: HNil
) extends AnyVal
    with Item14[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14] {
  override def eat[T](xyy: T): HListItem15[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, T] =
    new HListItem15[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, T](xyy :: head)
  override def rightHead: E14                                                                 = head.head
  override def rightTail: HListItem13[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13] = new HListItem13(head.tail)
