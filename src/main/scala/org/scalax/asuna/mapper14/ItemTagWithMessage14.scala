...
object ItemTagWithMessage14 {
  implicit def appendEatXyy14[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage14[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage14[
      H1,
      Message1,
      H2,
      Message2,
