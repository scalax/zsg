...
class TreeItem11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
  val item: org.scalax.asuna.mapper.item.EatValue0#AddRightItem[T1]#AddRightItem[T2]#AddRightItem[T3]#AddRightItem[T4]#AddRightItem[T5]#AddRightItem[T6]#AddRightItem[T7]#AddRightItem[
    ...
    with Item11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11] {
  override def eat[T](xyy: T): TreeItem12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T] =
    new TreeItem12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T](item.addRightItem(xyy))
  override def rightHead: T11                                                 = item.dropRightItem
  override def rightTail: TreeItem10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10] = new TreeItem10(item.dropRight)
...
class ReverseTreeItem11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
  val item: org.scalax.asuna.mapper.item.EatValue0#AddRightItem[T11]#AddRightItem[T10]#AddRightItem[T9]#AddRightItem[T8]#AddRightItem[T7]#AddRightItem[T6]#AddRightItem[
    ...
    with Item11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11] {
  override def pudao[T](xyy: T): ReverseTreeItem12[T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11] =
    new ReverseTreeItem12[T, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](item.addRightItem(xyy))
  override def leftHead: T1                                                          = item.dropRightItem
  override def leftTail: ReverseTreeItem10[T2, T3, T4, T5, T6, T7, T8, T9, T10, T11] = new ReverseTreeItem10(item.dropRight)
