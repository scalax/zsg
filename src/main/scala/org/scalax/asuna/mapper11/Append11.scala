...
class ItemTag11[
  ...
  override type XyyItemType = Item11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11]
  override type M[M <: org.scalax.asuna.mapper.item.Message] = ItemTag11[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  def debug[
    ...
    K,
    org.scalax.asuna.mapper.item.ItemTag11[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7, T8, M8, T9, M9, T10, M10, T11, M11],
    EatXyyType11[I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11]
  ] =
...
object ItemTag11 {
  implicit def appendEatXyy11[
    ...
    K,
    org.scalax.asuna.mapper.item.ItemTag11[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8, H9, M9, H10, M10, H11, M11],
    ...
    new org.scalax.asuna.mapper.Application[
      ...
      override def application(context: org.scalax.asuna.mapper.Context[K]): K#M[EatXyyType11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11]] = {
        if (context.isReverse) {
          context.append(ItemTag10.appendEatXyy10(t2, t3, t4, t5, t6, t7, t8, t9, t10, t11).application(context), t1.application(context), ArticleXyyPlus11.put11)
        } else {
          context.append(ItemTag10.appendEatXyy10(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10).application(context), t11.application(context), ArticleXyyPlus11.plus11)
        }
      }
    }
}
