...
class ItemTag11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11] extends org.scalax.asuna.mapper.item.ItemTag {
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11], EatXyyType11[
    I1,
    I2,
    I3,
    I4,
...
object ItemTag11 {
  implicit def appendEatXyy11[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag11[H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11], EatXyyType11[
    T1,
    T2,
    T3,
    T4,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag11[H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11], EatXyyType11[
      T1,
      T2,
      T3,
      T4,
