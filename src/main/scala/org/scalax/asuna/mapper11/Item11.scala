...
trait Item11[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11] extends Any {
  self =>
  def i1: E1
  def i2: E2
  def i3: E3
  ...
  def leftTail: Item10[E2, E3, E4, E5, E6, E7, E8, E9, E10, E11]                = throw new Exception("Can not use this method.")
  def rightHead: E11                                                            = throw new Exception("Can not use this method.")
  def rightTail: Item10[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10]                = throw new Exception("Can not use this method.")
  def eat[T](xyy: T): Item12[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, T]   = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item12[T, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11] = throw new Exception("Can not use this method.")
