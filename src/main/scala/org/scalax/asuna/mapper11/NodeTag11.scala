...
class NodeTag11[
  ...
  override type XyyItemType = Item11[
    T1#XyyItemType,
    T2#XyyItemType,
    T3#XyyItemType,
    T4#XyyItemType,
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag11[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  def debug[
    ...
    K,
    org.scalax.asuna.mapper.item.NodeTag11[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7, T8, M8, T9, M9, T10, M10, T11, M11],
...
object NodeTag11 {
  implicit def appendNodeTagEatXyy11[
    ...
    K,
    org.scalax.asuna.mapper.item.NodeTag11[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8, H9, M9, H10, M10, H11, M11],
...
class `Please change .debug(context) to .find11.debug(context).` extends org.scalax.asuna.mapper.item.Message
