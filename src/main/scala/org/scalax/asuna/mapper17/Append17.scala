...
class ItemTag17[
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = ItemTag17[
      T1
    , M :-<>-: M1
    , T2
    , M :-<>-: M2
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag17[
      T1
    , M1
    , T2
    , M2
...
object ItemTag17 {
  implicit def appendEatXyy17[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag17[
        H1
      , M1
      , H2
      , M2
