...
object ItemTagWithMessage17 {
  implicit def appendEatXyy17[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage17[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage17[
      H1,
      Message1,
      H2,
      Message2,
