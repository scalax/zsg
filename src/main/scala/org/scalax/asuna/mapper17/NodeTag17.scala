...
class NodeTag17[
  ...
  override type XyyItemType = Item17[
    T1#XyyItemType,
    T2#XyyItemType,
    T3#XyyItemType,
    T4#XyyItemType,
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag17[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag17[
    T1,
    M1,
    T2,
    M2,
...
object NodeTag17 {
  implicit def appendNodeTagEatXyy17[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag17[
      H1,
      M1,
      H2,
      M2,
