...
object ItemTagWithMessage21 {
  implicit def appendEatXyy21[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage21[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage21[
      H1,
      Message1,
      H2,
      Message2,
