...
class NodeTag21[
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag21[
      T1
    , M :-<>-: M1
    , T2
    , M :-<>-: M2
  ...
  def find14: T15#M[Asuna.`Number: 14`] = throw new Exception("debugging...")
  def find15: T16#M[Asuna.`Number: 15`] = throw new Exception("debugging...")
  def find16: T17#M[Asuna.`Number: 16`] = throw new Exception("debugging...")
  def find17: T18#M[Asuna.`Number: 17`] = throw new Exception("debugging...")
  def find18: T19#M[Asuna.`Number: 18`] = throw new Exception("debugging...")
  def find19: T20#M[Asuna.`Number: 19`] = throw new Exception("debugging...")
  def find20: T21#M[Asuna.`Number: 20`] = throw new Exception("debugging...")
  def debug[
    ...
    , dapp15: org.scalax.asuna.mapper.DebugApplication[K, T15, I15, Asuna.`Message: Please change .debug(context) to .find14.debug(context).`]
    , dapp16: org.scalax.asuna.mapper.DebugApplication[K, T16, I16, Asuna.`Message: Please change .debug(context) to .find15.debug(context).`]
    , dapp17: org.scalax.asuna.mapper.DebugApplication[K, T17, I17, Asuna.`Message: Please change .debug(context) to .find16.debug(context).`]
    , dapp18: org.scalax.asuna.mapper.DebugApplication[K, T18, I18, Asuna.`Message: Please change .debug(context) to .find17.debug(context).`]
    , dapp19: org.scalax.asuna.mapper.DebugApplication[K, T19, I19, Asuna.`Message: Please change .debug(context) to .find18.debug(context).`]
    , dapp20: org.scalax.asuna.mapper.DebugApplication[K, T20, I20, Asuna.`Message: Please change .debug(context) to .find19.debug(context).`]
    , dapp21: org.scalax.asuna.mapper.DebugApplication[K, T21, I21, Asuna.`Message: Please change .debug(context) to .find20.debug(context).`]
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag21[
      T1
    , M1
    , T2
    , M2
...
object NodeTag21 {
  implicit def appendNodeTagEatXyy21[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag21[
        H1
      , M1
      , H2
      , M2
...
class `Please change .debug(context) to .find21.debug(context).` extends org.scalax.asuna.mapper.item.Message
