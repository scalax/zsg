...
class NodeTag18[
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag18[
      T1
    , M :-<>-: M1
    , T2
    , M :-<>-: M2
  ...
  def debug[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag18[
      T1
    , M1
    , T2
    , M2
    ...
    NodeTag18.appendNodeTagEatXyy18(dapp1, dapp2, dapp3, dapp4, dapp5, dapp6, dapp7, dapp8, dapp9, dapp10, dapp11, dapp12, dapp13, dapp14, dapp15, dapp16, dapp17, dapp18)
}
object NodeTag18 {
  implicit def appendNodeTagEatXyy18[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag18[
        H1
      , M1
      , H2
      , M2
