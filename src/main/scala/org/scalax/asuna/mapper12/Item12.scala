...
trait Item12[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12] extends Any {
  self =>
  def i1: E1
  def i2: E2
  def i3: E3
  ...
  def leftTail: Item11[E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12]                = throw new Exception("Can not use this method.")
  def rightHead: E12                                                                 = throw new Exception("Can not use this method.")
  def rightTail: Item11[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11]                = throw new Exception("Can not use this method.")
  def eat[T](xyy: T): Item13[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, T]   = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item13[T, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12] = throw new Exception("Can not use this method.")
