...
class ItemTagWithMessage2[ T1, Message1 <: org.scalax.asuna.mapper.item.Message  ,   T2, Message2 <: org.scalax.asuna.mapper.item.Message  ] extends org.scalax.asuna.mapper.item.ItemTag {
