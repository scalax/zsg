...
object ItemTagWithMessage15 {
  implicit def appendEatXyy15[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage15[
    H1,
    Message1,
    H2,
    Message2,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTagWithMessage15[
      H1,
      Message1,
      H2,
      Message2,
