...
class NodeTag15[
  ...
  override type XyyItemType = Item15[
    T1#XyyItemType,
    T2#XyyItemType,
    T3#XyyItemType,
    T4#XyyItemType,
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag15[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag15[
    T1,
    M1,
    T2,
    M2,
...
object NodeTag15 {
  implicit def appendNodeTagEatXyy15[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag15[
      H1,
      M1,
      H2,
      M2,
