...
class NodeTag22[
  ...
  override type M[M <: org.scalax.asuna.mapper.item.Message] = NodeTag22[
    T1,
    M :-<>-: M1,
    T2,
    M :-<>-: M2,
  ...
  def find21: T22#M[Asuna.`Number: 21`] = throw new Exception("debugging...")
  def debug[
    ...
    dapp22: org.scalax.asuna.mapper.DebugApplication[K, T22, I22, Asuna.`Message: Please change .debug(context) to .find21.debug(context).`]
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag22[
    T1,
    M1,
    T2,
    M2,
...
object NodeTag22 {
  implicit def appendNodeTagEatXyy22[
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag22[
      H1,
      M1,
      H2,
      M2,
