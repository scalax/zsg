...
class NodeTag8[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag8[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7, T8, M8], EatXyyType8[
    I1,
    I2,
    I3,
    I4,
...
object NodeTag8 {
  implicit def appendNodeTagEatXyy8[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag8[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8], EatXyyType8[
    T1,
    T2,
    T3,
    T4,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag8[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8], EatXyyType8[
      T1,
      T2,
      T3,
      T4,
