...
trait Item8[E1, E2, E3, E4, E5, E6, E7, E8] extends Any {
  ...
  def eat[T](xyy: T): Item9[E1, E2, E3, E4, E5, E6, E7, E8, T]           = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item9[T, E1, E2, E3, E4, E5, E6, E7, E8]         = throw new Exception("Can not use this method.")
