...
context.append(ItemTag6.appendEatXyy6( t2  ,   t3  ,   t4  ,   t5  ,   t6  ,   t7  ).application(context), t1.application(context), ArticleXyyPlus.put7)
} else {
context.append(ItemTag6.appendEatXyy6( t1  ,   t2  ,   t3  ,   t4  ,   t5  ,   t6  ).application(context), t7.application(context), ArticleXyyPlus.plus7)
}
}
}
}
