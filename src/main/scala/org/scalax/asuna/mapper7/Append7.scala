...
class ItemTag7[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag7[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7], EatXyyType7[
    I1,
    I2,
    I3,
    I4,
...
object ItemTag7 {
  implicit def appendEatXyy7[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag7[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7], EatXyyType7[
    T1,
    T2,
    T3,
    T4,
    ...
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.ItemTag7[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7], EatXyyType7[
      T1,
      T2,
      T3,
      T4,
