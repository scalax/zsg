...
class NodeTag7[
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag7[T1, T2, T3, T4, T5, T6, T7], EatXyyType7[I1, I2, I3, I4, I5, I6, I7]] =
...
object NodeTag7 {
  ...
  ): org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag7[H1, H2, H3, H4, H5, H6, H7], EatXyyType7[T1, T2, T3, T4, T5, T6, T7]] =
    new org.scalax.asuna.mapper.Application[K, org.scalax.asuna.mapper.item.NodeTag7[H1, H2, H3, H4, H5, H6, H7], EatXyyType7[T1, T2, T3, T4, T5, T6, T7]] {
