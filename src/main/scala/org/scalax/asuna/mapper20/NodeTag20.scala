...
class NodeTag20[
  ...
  def debug[
    ...
    NodeTag20.appendNodeTagEatXyy20(
      dapp1,
      dapp2,
      dapp3,
      dapp4,
...
object NodeTag20 {
  implicit def appendNodeTagEatXyy20[
    ...
    K,
    org.scalax.asuna.mapper.item.NodeTag20[H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16, H17, H18, H19, H20],
    ...
    new org.scalax.asuna.mapper.Application[
      ...
      override def application(
        ...
        if (context.isReverse) {
          context.append(
              NodeTag19.appendNodeTagEatXyy19(t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20).application(context)
            , t1.application(context)
            , ArticleXyyPlus20.put20
          )
        } else {
          context.append(
              NodeTag19.appendNodeTagEatXyy19(t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19).application(context)
