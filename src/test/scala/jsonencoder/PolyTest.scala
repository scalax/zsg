...
trait Poly1 extends CircePoly {
  ...
  //override type PolyType = Poly1
  type CirceEncoder[I] = EncoderContent[I, (Poly1, Poly2)]
  //type CirceDecoder[I]   = DecoderContent[I, Poly1]
...
trait Poly2 extends CircePoly {
  ...
  //override type PolyType = (Poly1, Poly2)
  type CirceEncoder[T] = EncoderContent[T, (Poly1, Poly2)]
  ...
  implicit def implicit_e_7: CirceEncoder[Test07] = EncoderTest.implicitEncoder
  implicit def implicit_e_6: CirceEncoder[Test06] = EncoderTest.implicitEncoder*/
