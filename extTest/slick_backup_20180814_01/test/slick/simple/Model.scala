...
class FriendTable4Model(cons: Tag) extends FriendTable2(cons) with UmrHelper with RmuWriterQuery {
  ...
  lazy val shape6 = umr.caseOnly[FriendTable4Model, Friends6].compileDecoder.inputTable(this)
  lazy val reader6 = umr.effect(shape6).toSv

  lazy val shape7 = umr.caseOnly[FriendTable4Model, Friends7].compileDecoder.inputTable(this)
