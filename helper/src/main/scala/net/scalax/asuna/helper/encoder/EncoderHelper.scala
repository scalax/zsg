...
trait EncoderWrapperHelper1111[RepCol, DataCol, Wrapper[_, _] <: EncoderContent[_, _]] {
  def effect1111[Rep, D, Out](rep: Rep)(implicit shape: Lazy[EncoderShape[Rep, D, Out, RepCol, DataCol]]): Wrapper[Out, D]
}
