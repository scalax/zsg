...
import asuna.macros.single.deficient.{AsunaTupleDeficientApply, AsunaTupleGetterGeneric, DeficientProperty, ModelProperty}

object AsunaTupleDeficientGetterGenericCodeGenSample extends App {
