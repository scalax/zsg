...
import org.scalax.asuna.mapper.append.ShapelessTest.EncodeImplicit
...
object LargeModelTest extends App {
  ...
  /*trait LargeModelPoly11   {

    import CircePoly._

    implicit lazy val largeModel_1_en: EncodeImplicit[CirceLargeModel.LargeModel_1] = ShapelessTest.EncodeImplicit.encodeGeneric
    implicit lazy val largeModel_2_en: EncodeImplicit[CirceLargeModel.LargeModel_2] = ShapelessTest.EncodeImplicit.encodeGeneric
