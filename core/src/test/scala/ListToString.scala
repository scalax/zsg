...
import org.scalax.asuna.mapper.item.{Item0, ItemTag, TypeParam2}
import org.scalax.asuna.mapper.{Application, Context, KindContext, Plus, TypeParam}
...
class IContext extends KindContext {
  ...
  override type M[T <: TypeParam] = (T#H, T#T#H) => ListToString
...
object i extends Context[IContext] {
  ...
  override def append[X <: TypeParam, Y <: TypeParam, Z <: TypeParam](x: (X#H, X#T#H) => ListToString, y: (Y#H, Y#T#H) => ListToString, p: Plus[X, Y, Z]): (Z#H, Z#T#H) => ListToString = {
    { (i1: Z#H, i2: Z#T#H) =>
      val t1 = x(p.takeTail(i1), p.sub.takeTail(i2))
      val t2 = y(p.takeHead(i1), p.sub.takeHead(i2))
      new ListToString {
...
object in {
  ...
  def encoder[I1, I2 <: ItemTag, I3 <: TypeParam](implicit ii: AsunaGeneric.Aux[I1, I2], pp: Application[IContext, I2, I3], asunaGetterGeneric: AsunaGetterGeneric.Aux[I1, I3#H], asunaNameGeneric: AsunaNameGeneric.Aux[I1, I3#T#H]) = {
    new ListEncoder[I1] {
  ...
  implicit val pp1: Application[IContext, String, TypeParam2[String, String]] = new Application[IContext, String, TypeParam2[String, String]] {
  ...
  implicit val pp2: Application[IContext, Int, TypeParam2[Int, String]] = new Application[IContext, Int, TypeParam2[Int, String]] {
  ...
  implicit val pp3: Application[IContext, Long, TypeParam2[Long, String]] = new Application[IContext, Long, TypeParam2[Long, String]] {
