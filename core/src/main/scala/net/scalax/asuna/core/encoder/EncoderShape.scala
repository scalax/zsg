...
import org.scalax.asuna.core.encoder.impl.ListEncoderShapeImplicit
...
trait EncoderShape[-E, RepCol, DataCol] extends CommonShape[E, RepCol] {
  ...
  override def packed: EncoderShape.Aux[Target, Data, Target, RepCol, DataCol] = {
    new EncoderShape[Target, RepCol, DataCol] {
      ...
      override def buildRep(base: self.Target, oldRep: RepCol): RepCol                       = self.buildRep(base, oldRep)
