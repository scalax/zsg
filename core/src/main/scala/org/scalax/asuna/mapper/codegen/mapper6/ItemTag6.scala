...
object ItemTag6 {
implicit def itemTagApplicationImplicit6[K <: KindContext  , H1  , H2  , H3  , H4  , H5  , H6
, T1 <: TypeParameter  , T2 <: TypeParameter  , T3 <: TypeParameter  , T4 <: TypeParameter  , T5 <: TypeParameter  , T6 <: TypeParameter
