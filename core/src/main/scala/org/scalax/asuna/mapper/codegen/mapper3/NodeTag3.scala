...
object NodeTag3 {
implicit def noteTagApplicationImplicit3[K <: KindContext  , H1 <: ItemTag  , H2 <: ItemTag  , H3 <: ItemTag   , T1 <: TypeParameter, M1 <: Message  , T2 <: TypeParameter, M2 <: Message  , T3 <: TypeParameter, M3 <: Message ]
