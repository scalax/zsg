...
def hlistPlus2[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ]
: Plus[ItemTypeParameter1[ T1  ], T2, TupleTypeParameter2[ T1  ,   T2  ]] =
...
def hlistPut2[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ]
: Plus[ItemTypeParameter1[ T1  ], T2, TupleTypeParameter2[T2  , T1 ]] =
...
def hlistPlus3[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ]
: Plus[ItemTypeParameter2[ T1  ,   T2  ], T3, TupleTypeParameter3[ T1  ,   T2  ,   T3  ]] =
...
def hlistPut3[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ]
: Plus[ItemTypeParameter2[ T1  ,   T2  ], T3, TupleTypeParameter3[T3  , T1  , T2 ]] =
...
override def sub: Plus[ItemTypeParameter5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ]#T, T6#T, TupleTypeParameter6[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ]#T] = hlistPlus6[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ]
}
...
override def takeHead(t: (T6#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H )): Item5[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ] = ReverseHListItem0  .pull(t._6)  .pull(t._5)  .pull(t._4)  .pull(t._3)  .pull(t._2)
override def sub: Plus[ItemTypeParameter5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ]#T, T6#T, TupleTypeParameter6[T6  , T1  , T2  , T3  , T4  , T5 ]#T] = hlistPut6[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ]
}
...
override def takeHead(t: ( T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  )): Item6[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ] = HListItem0  .add(t._1)  .add(t._2)  .add(t._3)  .add(t._4)  .add(t._5)  .add(t._6)
override def sub: Plus[ItemTypeParameter6[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ]#T, T7#T, TupleTypeParameter7[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ]#T] = hlistPlus7[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ]
}
...
override def takeHead(t: (T7#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H  , T6#H )): Item6[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ] = ReverseHListItem0  .pull(t._7)  .pull(t._6)  .pull(t._5)  .pull(t._4)  .pull(t._3)  .pull(t._2)
override def sub: Plus[ItemTypeParameter6[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ]#T, T7#T, TupleTypeParameter7[T7  , T1  , T2  , T3  , T4  , T5  , T6 ]#T] = hlistPut7[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ]
}
def hlistPlus8[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ,   T4 <: TypeParameter  ,   T5 <: TypeParameter  ,   T6 <: TypeParameter  ,   T7 <: TypeParameter  ,   T8 <: TypeParameter  ]
...
override def takeHead(t: ( T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ,   T8#H  )): Item7[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ] = HListItem0  .add(t._1)  .add(t._2)  .add(t._3)  .add(t._4)  .add(t._5)  .add(t._6)  .add(t._7)
override def sub: Plus[ItemTypeParameter7[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ]#T, T8#T, TupleTypeParameter8[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ,   T8  ]#T] = hlistPlus8[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ,   T8#T  ]
}
def hlistPut8[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ,   T4 <: TypeParameter  ,   T5 <: TypeParameter  ,   T6 <: TypeParameter  ,   T7 <: TypeParameter  ,   T8 <: TypeParameter  ]
...
override def takeHead(t: (T8#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H  , T6#H  , T7#H )): Item7[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ] = ReverseHListItem0  .pull(t._8)  .pull(t._7)  .pull(t._6)  .pull(t._5)  .pull(t._4)  .pull(t._3)  .pull(t._2)
override def sub: Plus[ItemTypeParameter7[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ]#T, T8#T, TupleTypeParameter8[T8  , T1  , T2  , T3  , T4  , T5  , T6  , T7 ]#T] = hlistPut8[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ,   T8#T  ]
}
def hlistPlus9[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ,   T4 <: TypeParameter  ,   T5 <: TypeParameter  ,   T6 <: TypeParameter  ,   T7 <: TypeParameter  ,   T8 <: TypeParameter  ,   T9 <: TypeParameter  ]
...
override def takeHead(t: ( T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ,   T8#H  ,   T9#H  )): Item8[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ,   T8#H  ] = HListItem0  .add(t._1)  .add(t._2)  .add(t._3)  .add(t._4)  .add(t._5)  .add(t._6)  .add(t._7)  .add(t._8)
override def sub: Plus[ItemTypeParameter8[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ,   T8  ]#T, T9#T, TupleTypeParameter9[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ,   T8  ,   T9  ]#T] = hlistPlus9[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ,   T8#T  ,   T9#T  ]
}
def hlistPut9[ T1 <: TypeParameter  ,   T2 <: TypeParameter  ,   T3 <: TypeParameter  ,   T4 <: TypeParameter  ,   T5 <: TypeParameter  ,   T6 <: TypeParameter  ,   T7 <: TypeParameter  ,   T8 <: TypeParameter  ,   T9 <: TypeParameter  ]
...
override def plus(p: Item8[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ,   T8#H  ], item: T9#H): (T9#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H  , T6#H  , T7#H  , T8#H ) = p.pullToTuple(item)
override def takeTail(t: (T9#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H  , T6#H  , T7#H  , T8#H )): T9#H = t._1
override def takeHead(t: (T9#H  , T1#H  , T2#H  , T3#H  , T4#H  , T5#H  , T6#H  , T7#H  , T8#H )): Item8[ T1#H  ,   T2#H  ,   T3#H  ,   T4#H  ,   T5#H  ,   T6#H  ,   T7#H  ,   T8#H  ] = ReverseHListItem0  .pull(t._9)  .pull(t._8)  .pull(t._7)  .pull(t._6)  .pull(t._5)  .pull(t._4)  .pull(t._3)  .pull(t._2)
override def sub: Plus[ItemTypeParameter8[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ,   T6  ,   T7  ,   T8  ]#T, T9#T, TupleTypeParameter9[T9  , T1  , T2  , T3  , T4  , T5  , T6  , T7  , T8 ]#T] = hlistPut9[ T1#T  ,   T2#T  ,   T3#T  ,   T4#T  ,   T5#T  ,   T6#T  ,   T7#T  ,   T8#T  ,   T9#T  ]
}
}
object TupleTypeParameterPlus1 extends TupleTypeParameterPlus1
