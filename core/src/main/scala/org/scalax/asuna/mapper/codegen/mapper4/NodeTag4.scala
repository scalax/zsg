...
def debug[K <: KindContext  , I1 <: TypeParameter  , I2 <: TypeParameter  , I3 <: TypeParameter  , I4 <: TypeParameter ](c: Context[K])(implicit
...
object NodeTag4 {
implicit def noteTagApplicationImplicit4[K <: KindContext  , H1 <: ItemTag  , H2 <: ItemTag  , H3 <: ItemTag  , H4 <: ItemTag   , T1 <: TypeParameter, M1 <: Message  , T2 <: TypeParameter, M2 <: Message  , T3 <: TypeParameter, M3 <: Message  , T4 <: TypeParameter, M4 <: Message ]
