...
trait ItemTypeParameterPlus2 {
  def plus2[T1 <: TypeParameter, T2 <: TypeParameter]: Plus[ItemTypeParameter1[T1], T2, ItemTypeParameter2[T1, T2]] =
  ...
  def put2[T1 <: TypeParameter, T2 <: TypeParameter]: Plus[ItemTypeParameter1[T1], T2, ItemTypeParameter2[T2, T1]] =
