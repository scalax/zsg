...
trait ItemTypeParameterPlus8 {
  def plus8[
    ...
    new Plus[ItemTypeParameter7[T1, T2, T3, T4, T5, T6, T7], T8, ItemTypeParameter8[T1, T2, T3, T4, T5, T6, T7, T8]] {
      ...
      override def sub: Plus[ItemTypeParameter7[T1, T2, T3, T4, T5, T6, T7]#T, T8#T, ItemTypeParameter8[T1, T2, T3, T4, T5, T6, T7, T8]#T] =
  ...
  def put8[
    ...
    new Plus[ItemTypeParameter7[T1, T2, T3, T4, T5, T6, T7], T8, ItemTypeParameter8[T8, T1, T2, T3, T4, T5, T6, T7]] {
      ...
      override def sub: Plus[ItemTypeParameter7[T1, T2, T3, T4, T5, T6, T7]#T, T8#T, ItemTypeParameter8[T8, T1, T2, T3, T4, T5, T6, T7]#T] =
