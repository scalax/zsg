...
import impl._
class NodeTag5[ T1 <: ItemTag , M1 <: Message  ,   T2 <: ItemTag , M2 <: Message  ,   T3 <: ItemTag , M3 <: Message  ,   T4 <: ItemTag , M4 <: Message  ,   T5 <: ItemTag , M5 <: Message  ] extends ItemTag {
...
def debug[K <: KindContext  , I1 <: TypeParameter  , I2 <: TypeParameter  , I3 <: TypeParameter  , I4 <: TypeParameter  , I5 <: TypeParameter ](c: Context[K])(implicit
...
object NodeTag5 {
implicit def noteTagApplicationImplicit5[K <: KindContext  , H1 <: ItemTag  , H2 <: ItemTag  , H3 <: ItemTag  , H4 <: ItemTag  , H5 <: ItemTag   , T1 <: TypeParameter, M1 <: Message  , T2 <: TypeParameter, M2 <: Message  , T3 <: TypeParameter, M3 <: Message  , T4 <: TypeParameter, M4 <: Message  , T5 <: TypeParameter, M5 <: Message ]
