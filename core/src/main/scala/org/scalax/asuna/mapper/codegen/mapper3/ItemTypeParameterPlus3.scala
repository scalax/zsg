...
trait ItemTypeParameterPlus3 {
  def plus3[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter]: Plus[ItemTypeParameter2[T1, T2], T3, ItemTypeParameter3[T1, T2, T3]] =
  ...
  def put3[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter]: Plus[ItemTypeParameter2[T1, T2], T3, ItemTypeParameter3[T3, T1, T2]] =
