...
def add[T](xyy: T): Item4[ E1,  E2,  E3,  T] = throw new Exception("Can not use this method.")
def pull[T](xyy: T): Item4[T  , E1  , E2  , E3 ] = throw new Exception("Can not use this method.")
