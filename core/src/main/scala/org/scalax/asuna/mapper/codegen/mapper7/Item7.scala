...
trait Item7[E1, E2, E3, E4, E5, E6, E7] extends Any {
  ...
  def add[T](xyy: T): Item8[E1, E2, E3, E4, E5, E6, E7, T]    = throw new Exception("Can not use this method.")
  def pull[T](xyy: T): Item8[T, E1, E2, E3, E4, E5, E6, E7]   = throw new Exception("Can not use this method.")
