...
def plus4[ T1 <: org.scalax.asuna.mapper.TypeParam  ,   T2 <: org.scalax.asuna.mapper.TypeParam  ,   T3 <: org.scalax.asuna.mapper.TypeParam  ,   T4 <: org.scalax.asuna.mapper.TypeParam  ]
: org.scalax.asuna.mapper.Plus[EatXyyType3[ T1  ,   T2  ,   T3  ], T4, EatXyyType4[ T1  ,   T2  ,   T3  ,   T4  ]] =
...
def put4[ T1 <: org.scalax.asuna.mapper.TypeParam  ,   T2 <: org.scalax.asuna.mapper.TypeParam  ,   T3 <: org.scalax.asuna.mapper.TypeParam  ,   T4 <: org.scalax.asuna.mapper.TypeParam  ]
: org.scalax.asuna.mapper.Plus[EatXyyType3[ T1  ,   T2  ,   T3  ], T4, EatXyyType4[T4  , T1  , T2  , T3 ]] =
