...
class NodeTag4[T1 <: ItemTag, M1 <: Message, T2 <: ItemTag, M2 <: Message, T3 <: ItemTag, M3 <: Message, T4 <: ItemTag, M4 <: Message] extends ItemTag {
  ...
  ): Application[K, NodeTag4[T1, M1, T2, M2, T3, M3, T4, M4], EatXyyType4[I1, I2, I3, I4]] =
...
object NodeTag4 {
  ...
  ): Application[K, NodeTag4[H1, M1, H2, M2, H3, M3, H4, M4], EatXyyType4[T1, T2, T3, T4]] =
    new Application[K, NodeTag4[H1, M1, H2, M2, H3, M3, H4, M4], EatXyyType4[T1, T2, T3, T4]] {
      override def application(context: Context[K]): K#M[EatXyyType4[T1, T2, T3, T4]] = {
...
class `Please change .debug(context) to .find4.debug(context).` extends Message
