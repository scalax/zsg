...
class ItemTag4[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message, T4, M4 <: Message] extends ItemTag {
  ...
  ): Application[K, ItemTag4[T1, M1, T2, M2, T3, M3, T4, M4], EatXyyType4[I1, I2, I3, I4]] =
...
object ItemTag4 {
  ...
  ): Application[K, ItemTag4[H1, M1, H2, M2, H3, M3, H4, M4], EatXyyType4[T1, T2, T3, T4]] =
    new Application[K, ItemTag4[H1, M1, H2, M2, H3, M3, H4, M4], EatXyyType4[T1, T2, T3, T4]] {
