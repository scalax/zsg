...
class TreeItem4[ T1  ,   T2  ,   T3  ,   T4  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T1]  #AddRightItem[T2]  #AddRightItem[T3]  #AddRightItem[T4] ) extends AnyVal with Item4[ T1  ,   T2  ,   T3  ,   T4  ] {
...
class ReverseTreeItem4[ T1  ,   T2  ,   T3  ,   T4  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T4]  #AddRightItem[T3]  #AddRightItem[T2]  #AddRightItem[T1] ) extends AnyVal with Item4[ T1  ,   T2  ,   T3  ,   T4  ] {
