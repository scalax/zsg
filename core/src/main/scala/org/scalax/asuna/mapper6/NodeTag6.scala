...
class NodeTag6[
  ...
  ): Application[K, NodeTag6[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6], EatXyyType6[I1, I2, I3, I4, I5, I6]] =
...
object NodeTag6 {
  ...
  ): Application[K, NodeTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], EatXyyType6[T1, T2, T3, T4, T5, T6]] =
    new Application[K, NodeTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], EatXyyType6[T1, T2, T3, T4, T5, T6]] {
      override def application(context: Context[K]): K#M[EatXyyType6[T1, T2, T3, T4, T5, T6]] = {
...
class `Please change .debug(context) to .find6.debug(context).` extends Message
