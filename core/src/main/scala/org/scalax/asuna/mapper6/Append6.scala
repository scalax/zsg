...
class ItemTag6[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message, T4, M4 <: Message, T5, M5 <: Message, T6, M6 <: Message] extends ItemTag {
  ...
  ): Application[K, ItemTag6[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6], EatXyyType6[I1, I2, I3, I4, I5, I6]] =
...
object ItemTag6 {
  ...
  ): Application[K, ItemTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], EatXyyType6[T1, T2, T3, T4, T5, T6]] =
    new Application[K, ItemTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], EatXyyType6[T1, T2, T3, T4, T5, T6]] {
