...
trait Item6[E1, E2, E3, E4, E5, E6] extends Any {
  ...
  def eat[T](xyy: T): Item7[E1, E2, E3, E4, E5, E6, T]     = throw new Exception("Can not use this method.")
  def pudao[T](xyy: T): Item7[T, E1, E2, E3, E4, E5, E6]   = throw new Exception("Can not use this method.")
  def eatToTuple[T](xyy: T): (E1, E2, E3, E4, E5, E6, T)   = (self.i1, self.i2, self.i3, self.i4, self.i5, self.i6, xyy)
  def pudaoToTuple[T](xyy: T): (T, E1, E2, E3, E4, E5, E6) = (xyy, self.i1, self.i2, self.i3, self.i4, self.i5, self.i6)
