...
trait BuildTagContect {
  ...
  def tag[T1](t1: AppendTag[T1]): AppendTag[ItemTag1[T1, Asuna.`Number： 1`]] =
    new AppendTag[ItemTag1[T1, Asuna.`Number： 1`]]
  def nodeTag[T1 <: ItemTag](t1: AppendTag[T1]): AppendTag[NodeTag1[T1, Asuna.`Number： 1`]] =
...
//}
  ...
  def tag[T1, T2](t1: AppendTag[T1], t2: AppendTag[T2]): AppendTag[ItemTag2[T1, Asuna.`Number： 1`, T2, Asuna.`Number： 2`]] =
    new AppendTag[ItemTag2[T1, Asuna.`Number： 1`, T2, Asuna.`Number： 2`]]
  def nodeTag[T1 <: ItemTag, T2 <: ItemTag](t1: AppendTag[T1], t2: AppendTag[T2]): AppendTag[NodeTag2[T1, Asuna.`Number： 1`, T2, Asuna.`Number： 2`]] =
...
//}
  ...
  def tag[T1, T2, T3](t1: AppendTag[T1], t2: AppendTag[T2], t3: AppendTag[T3]): AppendTag[ItemTag3[T1, Asuna.`Number： 1`, T2, Asuna.`Number： 2`, T3, Asuna.`Number： 3`]] =
