...
object ArticleXyyTuplePlus {
  def hlistPlus2[T1 <: TypeParameter, T2 <: TypeParameter]: Plus[EatXyyType1[T1], T2, TupleTypeParameter2[T1, T2]] =
    new Plus[EatXyyType1[T1], T2, TupleTypeParameter2[T1, T2]] {
      ...
      override def sub: Plus[EatXyyType1[T1]#T, T2#T, TupleTypeParameter2[T1, T2]#T] = hlistPlus2[T1#T, T2#T]
    }
  def hlistPut2[T1 <: TypeParameter, T2 <: TypeParameter]: Plus[EatXyyType1[T1], T2, TupleTypeParameter2[T2, T1]] =
    new Plus[EatXyyType1[T1], T2, TupleTypeParameter2[T2, T1]] {
      ...
      override def sub: Plus[EatXyyType1[T1]#T, T2#T, TupleTypeParameter2[T2, T1]#T] = hlistPut2[T1#T, T2#T]
    }
  def hlistPlus3[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter]: Plus[EatXyyType2[T1, T2], T3, TupleTypeParameter3[T1, T2, T3]] =
    new Plus[EatXyyType2[T1, T2], T3, TupleTypeParameter3[T1, T2, T3]] {
      ...
      override def sub: Plus[EatXyyType2[T1, T2]#T, T3#T, TupleTypeParameter3[T1, T2, T3]#T] = hlistPlus3[T1#T, T2#T, T3#T]
    }
  def hlistPut3[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter]: Plus[EatXyyType2[T1, T2], T3, TupleTypeParameter3[T3, T1, T2]] =
    new Plus[EatXyyType2[T1, T2], T3, TupleTypeParameter3[T3, T1, T2]] {
      ...
      override def sub: Plus[EatXyyType2[T1, T2]#T, T3#T, TupleTypeParameter3[T3, T1, T2]#T] = hlistPut3[T1#T, T2#T, T3#T]
    }
  def hlistPlus4[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter]
    : Plus[EatXyyType3[T1, T2, T3], T4, TupleTypeParameter4[T1, T2, T3, T4]] =
    new Plus[EatXyyType3[T1, T2, T3], T4, TupleTypeParameter4[T1, T2, T3, T4]] {
      ...
      override def sub: Plus[EatXyyType3[T1, T2, T3]#T, T4#T, TupleTypeParameter4[T1, T2, T3, T4]#T] = hlistPlus4[T1#T, T2#T, T3#T, T4#T]
    }
  def hlistPut4[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter]
    : Plus[EatXyyType3[T1, T2, T3], T4, TupleTypeParameter4[T4, T1, T2, T3]] =
    new Plus[EatXyyType3[T1, T2, T3], T4, TupleTypeParameter4[T4, T1, T2, T3]] {
      ...
      override def sub: Plus[EatXyyType3[T1, T2, T3]#T, T4#T, TupleTypeParameter4[T4, T1, T2, T3]#T] = hlistPut4[T1#T, T2#T, T3#T, T4#T]
    }
  def hlistPlus5[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter]
    : Plus[EatXyyType4[T1, T2, T3, T4], T5, TupleTypeParameter5[T1, T2, T3, T4, T5]] =
    new Plus[EatXyyType4[T1, T2, T3, T4], T5, TupleTypeParameter5[T1, T2, T3, T4, T5]] {
      ...
      override def sub: Plus[EatXyyType4[T1, T2, T3, T4]#T, T5#T, TupleTypeParameter5[T1, T2, T3, T4, T5]#T] = hlistPlus5[T1#T, T2#T, T3#T, T4#T, T5#T]
    }
  def hlistPut5[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter]
    : Plus[EatXyyType4[T1, T2, T3, T4], T5, TupleTypeParameter5[T5, T1, T2, T3, T4]] =
    new Plus[EatXyyType4[T1, T2, T3, T4], T5, TupleTypeParameter5[T5, T1, T2, T3, T4]] {
      ...
      override def sub: Plus[EatXyyType4[T1, T2, T3, T4]#T, T5#T, TupleTypeParameter5[T5, T1, T2, T3, T4]#T] = hlistPut5[T1#T, T2#T, T3#T, T4#T, T5#T]
    }
  def hlistPlus6[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter, T6 <: TypeParameter]
    : Plus[EatXyyType5[T1, T2, T3, T4, T5], T6, TupleTypeParameter6[T1, T2, T3, T4, T5, T6]] =
    new Plus[EatXyyType5[T1, T2, T3, T4, T5], T6, TupleTypeParameter6[T1, T2, T3, T4, T5, T6]] {
      ...
      override def sub: Plus[EatXyyType5[T1, T2, T3, T4, T5]#T, T6#T, TupleTypeParameter6[T1, T2, T3, T4, T5, T6]#T] = hlistPlus6[T1#T, T2#T, T3#T, T4#T, T5#T, T6#T]
    }
  def hlistPut6[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter, T6 <: TypeParameter]
    : Plus[EatXyyType5[T1, T2, T3, T4, T5], T6, TupleTypeParameter6[T6, T1, T2, T3, T4, T5]] =
    new Plus[EatXyyType5[T1, T2, T3, T4, T5], T6, TupleTypeParameter6[T6, T1, T2, T3, T4, T5]] {
      ...
      override def sub: Plus[EatXyyType5[T1, T2, T3, T4, T5]#T, T6#T, TupleTypeParameter6[T6, T1, T2, T3, T4, T5]#T] = hlistPut6[T1#T, T2#T, T3#T, T4#T, T5#T, T6#T]
    }
  def hlistPlus7[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter, T6 <: TypeParameter, T7 <: TypeParameter]
    : Plus[EatXyyType6[T1, T2, T3, T4, T5, T6], T7, TupleTypeParameter7[T1, T2, T3, T4, T5, T6, T7]] =
    new Plus[EatXyyType6[T1, T2, T3, T4, T5, T6], T7, TupleTypeParameter7[T1, T2, T3, T4, T5, T6, T7]] {
      ...
      override def sub: Plus[EatXyyType6[T1, T2, T3, T4, T5, T6]#T, T7#T, TupleTypeParameter7[T1, T2, T3, T4, T5, T6, T7]#T] =
  ...
  def hlistPut7[T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, T4 <: TypeParameter, T5 <: TypeParameter, T6 <: TypeParameter, T7 <: TypeParameter]
    : Plus[EatXyyType6[T1, T2, T3, T4, T5, T6], T7, TupleTypeParameter7[T7, T1, T2, T3, T4, T5, T6]] =
    new Plus[EatXyyType6[T1, T2, T3, T4, T5, T6], T7, TupleTypeParameter7[T7, T1, T2, T3, T4, T5, T6]] {
      ...
      override def sub: Plus[EatXyyType6[T1, T2, T3, T4, T5, T6]#T, T7#T, TupleTypeParameter7[T7, T1, T2, T3, T4, T5, T6]#T] =
  ...
  def hlistPlus8[
    ...
    T7 <: TypeParameter,
    T8 <: TypeParameter
  ]: Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7], T8, TupleTypeParameter8[T1, T2, T3, T4, T5, T6, T7, T8]] =
    new Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7], T8, TupleTypeParameter8[T1, T2, T3, T4, T5, T6, T7, T8]] {
      ...
      override def sub: Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7]#T, T8#T, TupleTypeParameter8[T1, T2, T3, T4, T5, T6, T7, T8]#T] =
  ...
  def hlistPut8[
    ...
    T7 <: TypeParameter,
    T8 <: TypeParameter
  ]: Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7], T8, TupleTypeParameter8[T8, T1, T2, T3, T4, T5, T6, T7]] =
    new Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7], T8, TupleTypeParameter8[T8, T1, T2, T3, T4, T5, T6, T7]] {
      ...
      override def sub: Plus[EatXyyType7[T1, T2, T3, T4, T5, T6, T7]#T, T8#T, TupleTypeParameter8[T8, T1, T2, T3, T4, T5, T6, T7]#T] =
  ...
  def hlistPlus9[
    ...
    T8 <: TypeParameter,
    T9 <: TypeParameter
  ]: Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8], T9, TupleTypeParameter9[T1, T2, T3, T4, T5, T6, T7, T8, T9]] =
    new Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8], T9, TupleTypeParameter9[T1, T2, T3, T4, T5, T6, T7, T8, T9]] {
      ...
      override def sub: Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8]#T, T9#T, TupleTypeParameter9[T1, T2, T3, T4, T5, T6, T7, T8, T9]#T] =
  ...
  def hlistPut9[
    ...
    T8 <: TypeParameter,
    T9 <: TypeParameter
  ]: Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8], T9, TupleTypeParameter9[T9, T1, T2, T3, T4, T5, T6, T7, T8]] =
    new Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8], T9, TupleTypeParameter9[T9, T1, T2, T3, T4, T5, T6, T7, T8]] {
      ...
      override def sub: Plus[EatXyyType8[T1, T2, T3, T4, T5, T6, T7, T8]#T, T9#T, TupleTypeParameter9[T9, T1, T2, T3, T4, T5, T6, T7, T8]#T] =
