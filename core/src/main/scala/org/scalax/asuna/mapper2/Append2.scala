...
object ItemTag2 {
implicit def appendEatXyy2[K <: org.scalax.asuna.mapper.KindContext  , H1  , H2
, T1 <: org.scalax.asuna.mapper.TypeParam  , T2 <: org.scalax.asuna.mapper.TypeParam
, M1 <: org.scalax.asuna.mapper.item.Message  , M2 <: org.scalax.asuna.mapper.item.Message ]
