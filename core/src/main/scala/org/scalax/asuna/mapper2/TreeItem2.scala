...
class TreeItem2[ T1  ,   T2  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T1]  #AddRightItem[T2] ) extends AnyVal with Item2[ T1  ,   T2  ] {
...
class ReverseTreeItem2[ T1  ,   T2  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T2]  #AddRightItem[T1] ) extends AnyVal with Item2[ T1  ,   T2  ] {
