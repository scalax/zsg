...
class TreeItem3[ T1  ,   T2  ,   T3  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T1]  #AddRightItem[T2]  #AddRightItem[T3] ) extends AnyVal with Item3[ T1  ,   T2  ,   T3  ] {
...
class ReverseTreeItem3[ T1  ,   T2  ,   T3  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T3]  #AddRightItem[T2]  #AddRightItem[T1] ) extends AnyVal with Item3[ T1  ,   T2  ,   T3  ] {
