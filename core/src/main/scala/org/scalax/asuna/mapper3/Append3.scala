...
class ItemTag3[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message] extends ItemTag {
  ...
  ): Application[K, ItemTag3[T1, M1, T2, M2, T3, M3], EatXyyType3[I1, I2, I3]] =
    ItemTag3.appendEatXyy3(dapp1, dapp2, dapp3)
}
object ItemTag3 {
  implicit def appendEatXyy3[K <: KindContext, H1, H2, H3, T1 <: TypeParameter, T2 <: TypeParameter, T3 <: TypeParameter, M1 <: Message, M2 <: Message, M3 <: Message](
    implicit t1: Application[K, H1, T1],
    t2: Application[K, H2, T2],
    t3: Application[K, H3, T3]
  ): Application[K, ItemTag3[H1, M1, H2, M2, H3, M3], EatXyyType3[T1, T2, T3]] =
    new Application[K, ItemTag3[H1, M1, H2, M2, H3, M3], EatXyyType3[T1, T2, T3]] {
