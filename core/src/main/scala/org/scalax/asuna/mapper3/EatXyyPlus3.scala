...
def plus3[ T1 <: org.scalax.asuna.mapper.TypeParam  ,   T2 <: org.scalax.asuna.mapper.TypeParam  ,   T3 <: org.scalax.asuna.mapper.TypeParam  ]
: org.scalax.asuna.mapper.Plus[EatXyyType2[ T1  ,   T2  ], T3, EatXyyType3[ T1  ,   T2  ,   T3  ]] =
...
def put3[ T1 <: org.scalax.asuna.mapper.TypeParam  ,   T2 <: org.scalax.asuna.mapper.TypeParam  ,   T3 <: org.scalax.asuna.mapper.TypeParam  ]
: org.scalax.asuna.mapper.Plus[EatXyyType2[ T1  ,   T2  ], T3, EatXyyType3[T3  , T1  , T2 ]] =
