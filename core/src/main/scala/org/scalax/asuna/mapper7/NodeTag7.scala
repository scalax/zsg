...
class NodeTag7[
  ...
  ): Application[K, NodeTag7[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7], EatXyyType7[I1, I2, I3, I4, I5, I6, I7]] =
...
object NodeTag7 {
  ...
  ): Application[K, NodeTag7[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7], EatXyyType7[T1, T2, T3, T4, T5, T6, T7]] =
    new Application[K, NodeTag7[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7], EatXyyType7[T1, T2, T3, T4, T5, T6, T7]] {
      override def application(context: Context[K]): K#M[EatXyyType7[T1, T2, T3, T4, T5, T6, T7]] = {
...
class `Please change .debug(context) to .find7.debug(context).` extends Message
