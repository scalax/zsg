...
trait Item5[E1, E2, E3, E4, E5] extends Any {
  ...
  def eatToTuple[T](xyy: T): (E1, E2, E3, E4, E5, T)   = (self.i1, self.i2, self.i3, self.i4, self.i5, xyy)
  def pudaoToTuple[T](xyy: T): (T, E1, E2, E3, E4, E5) = (xyy, self.i1, self.i2, self.i3, self.i4, self.i5)
