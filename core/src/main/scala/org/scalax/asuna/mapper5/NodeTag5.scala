...
class NodeTag5[T1 <: ItemTag, M1 <: Message, T2 <: ItemTag, M2 <: Message, T3 <: ItemTag, M3 <: Message, T4 <: ItemTag, M4 <: Message, T5 <: ItemTag, M5 <: Message]
  ...
  ): Application[K, NodeTag5[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5], EatXyyType5[I1, I2, I3, I4, I5]] =
...
object NodeTag5 {
  ...
  ): Application[K, NodeTag5[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5], EatXyyType5[T1, T2, T3, T4, T5]] =
    new Application[K, NodeTag5[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5], EatXyyType5[T1, T2, T3, T4, T5]] {
      override def application(context: Context[K]): K#M[EatXyyType5[T1, T2, T3, T4, T5]] = {
...
class `Please change .debug(context) to .find5.debug(context).` extends Message
