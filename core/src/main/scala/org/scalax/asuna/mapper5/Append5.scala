...
class ItemTag5[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message, T4, M4 <: Message, T5, M5 <: Message] extends ItemTag {
  ...
  ): Application[K, ItemTag5[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5], EatXyyType5[I1, I2, I3, I4, I5]] =
...
object ItemTag5 {
  ...
  ): Application[K, ItemTag5[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5], EatXyyType5[T1, T2, T3, T4, T5]] =
    new Application[K, ItemTag5[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5], EatXyyType5[T1, T2, T3, T4, T5]] {
