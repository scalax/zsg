...
class TreeItem5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T1]  #AddRightItem[T2]  #AddRightItem[T3]  #AddRightItem[T4]  #AddRightItem[T5] ) extends AnyVal with Item5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ] {
...
class ReverseTreeItem5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ](val item: org.scalax.asuna.mapper.item.EatValue0  #AddRightItem[T5]  #AddRightItem[T4]  #AddRightItem[T3]  #AddRightItem[T2]  #AddRightItem[T1] ) extends AnyVal with Item5[ T1  ,   T2  ,   T3  ,   T4  ,   T5  ] {
