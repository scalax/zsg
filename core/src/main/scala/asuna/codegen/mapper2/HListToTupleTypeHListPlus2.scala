...
override def plus(p: HListTypeHList1[ AnyTypeHList  ]#H,
item: AnyTypeHList#H): TupleTypeHList2[ AnyTypeHList  ,   AnyTypeHList  ]#H = {
val ii1 = p.head
...
@inline def put2[ T1 <: TypeHList  ,   T2 <: TypeHList  ]
: Plus[HListTypeHList1[ T1  ], T2, TupleTypeHList2[T2  , T1 ]] =
