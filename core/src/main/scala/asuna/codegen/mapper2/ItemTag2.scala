...
class ItemTag2[T1, M1 <: Message, T2, M2 <: Message] extends ItemTag {
  override type ItemType        = AsunaTuple2[T1, T2]
  ...
  ): Application[K, ItemTag2[T1, M1, T2, M2], TupleTypeHList2[I1, I2]] =
...
object ItemTag2 {
  ...
  ): Application[K, ItemTag2[H1, M1, H2, M2], TupleTypeHList2[T1, T2]] =
    new Application[K, ItemTag2[H1, M1, H2, M2], TupleTypeHList2[T1, T2]] {
...
//context.append(ItemTag1.itemTagApplicationImplicit1( t2  ).application(context), t1.application(context), TupleTypeHListPlus2.put2)
        } else {
...
//context.append(ItemTag1.itemTagApplicationImplicit1( t1  ).application(context), t2.application(context), TupleTypeHListPlus2.plus2)
        }
      }
    }
}
