...
//context.append(TupleTag1.itemTagApplicationImplicit1( t2  ).application(context), t1.application(context), TupleTypeHListPlus2.put2)
        } else {
...
//context.append(TupleTag1.itemTagApplicationImplicit1( t1  ).application(context), t2.application(context), TupleTypeHListPlus2.plus2)
        }
      }
    }
}
