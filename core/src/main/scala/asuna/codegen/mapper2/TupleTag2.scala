...
def debug[K <: KindContext  , I1 <: TypeHList  , I2 <: TypeHList ](c: Context[K])(implicit
...
object TupleTag2 {
implicit def tupleTagApplicationImplicit2[K <: KindContext  , H1  , H2
...
context.append[TupleTypeHList0, T2, HListTypeHList1[T2]]
(context.start, t2.application(context), AnyHListTypeHListPlus.hlistPlus1)
,
t1.application(context), HListToTupleTypeHListPlus2.put2)
} else {
context.append[HListTypeHList1
[T1 ],
T2,
...
,
t2.application(context), HListToTupleTypeHListPlus2.plus2)
}
}
}
}
