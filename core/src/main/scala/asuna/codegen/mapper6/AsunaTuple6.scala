...
trait AsunaTuple6[E1, E2, E3, E4, E5, E6] extends Any {
  ...
  def leftTail: AsunaTuple5[E2, E3, E4, E5, E6]               = throw new Exception("Can not use this method.")
  def rightHead: E6                                           = throw new Exception("Can not use this method.")
  def rightTail: AsunaTuple5[E1, E2, E3, E4, E5]              = throw new Exception("Can not use this method.")
  def add[T](xyy: T): AsunaTuple7[E1, E2, E3, E4, E5, E6, T]  = throw new Exception("Can not use this method.")
  def pull[T](xyy: T): AsunaTuple7[T, E1, E2, E3, E4, E5, E6] = throw new Exception("Can not use this method.")
