...
class ItemTag6[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message, T4, M4 <: Message, T5, M5 <: Message, T6, M6 <: Message] extends ItemTag {
  override type ItemType        = AsunaTuple6[T1, T2, T3, T4, T5, T6]
  ...
  ): Application[K, ItemTag6[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6], TupleTypeHList6[I1, I2, I3, I4, I5, I6]] =
...
object ItemTag6 {
  ...
  ): Application[K, ItemTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], TupleTypeHList6[T1, T2, T3, T4, T5, T6]] =
    new Application[K, ItemTag6[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6], TupleTypeHList6[T1, T2, T3, T4, T5, T6]] {
...
//context.append(ItemTag5.itemTagApplicationImplicit5( t2  ,   t3  ,   t4  ,   t5  ,   t6  ).application(context), t1.application(context), TupleTypeHListPlus6.put6)
        } else {
...
//context.append(ItemTag5.itemTagApplicationImplicit5( t1  ,   t2  ,   t3  ,   t4  ,   t5  ).application(context), t6.application(context), TupleTypeHListPlus6.plus6)
        }
      }
    }
}
