package asuna
import impl._
class NodeTag6[ T1 <: TupleTag , M1 <: Message  ,   T2 <: TupleTag , M2 <: Message  ,   T3 <: TupleTag , M3 <: Message  ,   T4 <: TupleTag , M4 <: Message  ,   T5 <: TupleTag , M5 <: Message  ,   T6 <: TupleTag , M6 <: Message  ] extends TupleTag {
...
def debug[K <: KindContext  , I1 <: TypeHList  , I2 <: TypeHList  , I3 <: TypeHList  , I4 <: TypeHList  , I5 <: TypeHList  , I6 <: TypeHList ](c: Context[K])(implicit
...
object NodeTag6 {
implicit def noteTagApplicationImplicit6[K <: KindContext  , H1 <: TupleTag  , H2 <: TupleTag  , H3 <: TupleTag  , H4 <: TupleTag  , H5 <: TupleTag  , H6 <: TupleTag   , T1 <: TypeHList, M1 <: Message  , T2 <: TypeHList, M2 <: Message  , T3 <: TypeHList, M3 <: Message  , T4 <: TypeHList, M4 <: Message  , T5 <: TypeHList, M5 <: Message  , T6 <: TypeHList, M6 <: Message ]
...
context.append[TupleTypeHList0, T6, HListTypeHList1[T6]]
(context.start, t6.application(context), AnyHListTypeHListPlus.hlistPlus1)
,
t5.application(context), HListTypeHListPlus2.plus2)
,
t4.application(context), HListTypeHListPlus3.plus3)
,
t3.application(context), HListTypeHListPlus4.plus4)
,
t2.application(context), HListTypeHListPlus5.plus5)
,
t1.application(context), HListToTupleTypeHListPlus6.put6)
} else {
context.append[HListTypeHList5
[T1  , T2  , T3  , T4  , T5 ],
T6,
...
,
t6.application(context), HListToTupleTypeHListPlus6.plus6)
}
}
}
}
