...
class ItemTag3[T1, M1 <: Message, T2, M2 <: Message, T3, M3 <: Message] extends ItemTag {
  override type ItemType        = AsunaTuple3[T1, T2, T3]
  ...
  ): Application[K, ItemTag3[T1, M1, T2, M2, T3, M3], TupleTypeHList3[I1, I2, I3]] =
...
object ItemTag3 {
  ...
  ): Application[K, ItemTag3[H1, M1, H2, M2, H3, M3], TupleTypeHList3[T1, T2, T3]] =
    new Application[K, ItemTag3[H1, M1, H2, M2, H3, M3], TupleTypeHList3[T1, T2, T3]] {
...
//context.append(ItemTag2.itemTagApplicationImplicit2( t2  ,   t3  ).application(context), t1.application(context), TupleTypeHListPlus3.put3)
        } else {
...
//context.append(ItemTag2.itemTagApplicationImplicit2( t1  ,   t2  ).application(context), t3.application(context), TupleTypeHListPlus3.plus3)
        }
      }
    }
}
