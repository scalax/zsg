...
override def plus(p: HListTypeHList2[ AnyTypeHList  ,   AnyTypeHList  ]#H,
item: AnyTypeHList#H): TupleTypeHList3[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#H = {
val ii1 = p.head
val tt1 = p.tail
val ii2 = tt1.head
...
@inline def put3[ T1 <: TypeHList  ,   T2 <: TypeHList  ,   T3 <: TypeHList  ]
: Plus[HListTypeHList2[ T1  ,   T2  ], T3, TupleTypeHList3[T3  , T2  , T1 ]] =
