...
def debug[K <: KindContext  , I1 <: TypeHList  , I2 <: TypeHList  , I3 <: TypeHList ](c: Context[K])(implicit
...
object NodeTag3 {
implicit def noteTagApplicationImplicit3[K <: KindContext  , H1 <: TupleTag  , H2 <: TupleTag  , H3 <: TupleTag   , T1 <: TypeHList, M1 <: Message  , T2 <: TypeHList, M2 <: Message  , T3 <: TypeHList, M3 <: Message ]
...
context.append[TupleTypeHList0, T3, HListTypeHList1[T3]]
(context.start, t3.application(context), AnyHListTypeHListPlus.hlistPlus1)
,
t2.application(context), HListTypeHListPlus2.plus2)
,
t1.application(context), HListToTupleTypeHListPlus3.put3)
} else {
context.append[HListTypeHList2
[T1  , T2 ],
T3,
...
t2.application(context), HListTypeHListPlus2.plus2)
,
t3.application(context), HListToTupleTypeHListPlus3.plus3)
}
}
}
}
