package asuna
import impl._
class NodeTag8[ T1 <: TupleTag , M1 <: Message  ,   T2 <: TupleTag , M2 <: Message  ,   T3 <: TupleTag , M3 <: Message  ,   T4 <: TupleTag , M4 <: Message  ,   T5 <: TupleTag , M5 <: Message  ,   T6 <: TupleTag , M6 <: Message  ,   T7 <: TupleTag , M7 <: Message  ,   T8 <: TupleTag , M8 <: Message  ] extends TupleTag {
override type AsunaTupleType = AsunaTuple8[ T1#AsunaTupleType  ,   T2#AsunaTupleType  ,   T3#AsunaTupleType  ,   T4#AsunaTupleType  ,   T5#AsunaTupleType  ,   T6#AsunaTupleType  ,   T7#AsunaTupleType  ,   T8#AsunaTupleType  ]
...
def debug[K <: KindContext  , I1 <: TypeHList  , I2 <: TypeHList  , I3 <: TypeHList  , I4 <: TypeHList  , I5 <: TypeHList  , I6 <: TypeHList  , I7 <: TypeHList  , I8 <: TypeHList ](c: Context[K])(implicit
...
object NodeTag8 {
implicit def noteTagApplicationImplicit8[K <: KindContext  , H1 <: TupleTag  , H2 <: TupleTag  , H3 <: TupleTag  , H4 <: TupleTag  , H5 <: TupleTag  , H6 <: TupleTag  , H7 <: TupleTag  , H8 <: TupleTag   , T1 <: TypeHList, M1 <: Message  , T2 <: TypeHList, M2 <: Message  , T3 <: TypeHList, M3 <: Message  , T4 <: TypeHList, M4 <: Message  , T5 <: TypeHList, M5 <: Message  , T6 <: TypeHList, M6 <: Message  , T7 <: TypeHList, M7 <: Message  , T8 <: TypeHList, M8 <: Message ]
...
context.append[HListTypeHList7
[T8  , T7  , T6  , T5  , T4  , T3  , T2 ],
T1,
TupleTypeHList8
[T1  , T2  , T3  , T4  , T5  , T6  , T7  , T8 ]
](
context.append[HListTypeHList6
[T8  , T7  , T6  , T5  , T4  , T3 ],
T2,
HListTypeHList7
[T8  , T7  , T6  , T5  , T4  , T3  , T2 ]
](
context.append[HListTypeHList5
[T8  , T7  , T6  , T5  , T4 ],
T3,
HListTypeHList6
[T8  , T7  , T6  , T5  , T4  , T3 ]
...
context.append[TupleTypeHList0, T8, HListTypeHList1[T8]]
(context.start, t8.application(context), AnyHListTypeHListPlus.hlistPlus1)
,
t7.application(context), HListTypeHListPlus2.plus2)
,
t6.application(context), HListTypeHListPlus3.plus3)
,
t5.application(context), HListTypeHListPlus4.plus4)
,
t4.application(context), HListTypeHListPlus5.plus5)
,
t3.application(context), HListTypeHListPlus6.plus6)
,
t2.application(context), HListTypeHListPlus7.plus7)
,
t1.application(context), HListToTupleTypeHListPlus8.put8)
} else {
context.append[HListTypeHList7
...
,
t5.application(context), HListTypeHListPlus5.plus5)
,
t6.application(context), HListTypeHListPlus6.plus6)
,
t7.application(context), HListTypeHListPlus7.plus7)
,
t8.application(context), HListToTupleTypeHListPlus8.plus8)
}
}
}
}
