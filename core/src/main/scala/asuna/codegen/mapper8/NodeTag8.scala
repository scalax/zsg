...
class NodeTag8[
  ...
  ): Application[K, NodeTag8[T1, M1, T2, M2, T3, M3, T4, M4, T5, M5, T6, M6, T7, M7, T8, M8], ItemTypeHList8[I1, I2, I3, I4, I5, I6, I7, I8]] =
...
object NodeTag8 {
  ...
  ): Application[K, NodeTag8[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8], ItemTypeHList8[T1, T2, T3, T4, T5, T6, T7, T8]] =
    new Application[K, NodeTag8[H1, M1, H2, M2, H3, M3, H4, M4, H5, M5, H6, M6, H7, M7, H8, M8], ItemTypeHList8[T1, T2, T3, T4, T5, T6, T7, T8]] {
...
//context.append(NodeTag7.noteTagApplicationImplicit7( t2  ,   t3  ,   t4  ,   t5  ,   t6  ,   t7  ,   t8  ).application(context), t1.application(context), ItemTypeHListPlus8.put8)
        } else {
...
//context.append(NodeTag7.noteTagApplicationImplicit7( t1  ,   t2  ,   t3  ,   t4  ,   t5  ,   t6  ,   t7  ).application(context), t8.application(context), ItemTypeHListPlus8.plus8)
        }
      }
    }
}
