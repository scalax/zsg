package asuna
import impl._
class NodeTag7[ T1 <: TupleTag , M1 <: Message  ,   T2 <: TupleTag , M2 <: Message  ,   T3 <: TupleTag , M3 <: Message  ,   T4 <: TupleTag , M4 <: Message  ,   T5 <: TupleTag , M5 <: Message  ,   T6 <: TupleTag , M6 <: Message  ,   T7 <: TupleTag , M7 <: Message  ] extends TupleTag {
override type AsunaTupleType = AsunaTuple7[ T1#AsunaTupleType  ,   T2#AsunaTupleType  ,   T3#AsunaTupleType  ,   T4#AsunaTupleType  ,   T5#AsunaTupleType  ,   T6#AsunaTupleType  ,   T7#AsunaTupleType  ]
...
def debug[K <: KindContext  , I1 <: TypeHList  , I2 <: TypeHList  , I3 <: TypeHList  , I4 <: TypeHList  , I5 <: TypeHList  , I6 <: TypeHList  , I7 <: TypeHList ](c: Context[K])(implicit
...
object NodeTag7 {
implicit def noteTagApplicationImplicit7[K <: KindContext  , H1 <: TupleTag  , H2 <: TupleTag  , H3 <: TupleTag  , H4 <: TupleTag  , H5 <: TupleTag  , H6 <: TupleTag  , H7 <: TupleTag   , T1 <: TypeHList, M1 <: Message  , T2 <: TypeHList, M2 <: Message  , T3 <: TypeHList, M3 <: Message  , T4 <: TypeHList, M4 <: Message  , T5 <: TypeHList, M5 <: Message  , T6 <: TypeHList, M6 <: Message  , T7 <: TypeHList, M7 <: Message ]
...
context.append[TupleTypeHList0, T7, HListTypeHList1[T7]]
(context.start, t7.application(context), AnyHListTypeHListPlus.hlistPlus1)
,
t6.application(context), HListTypeHListPlus2.plus2)
,
t5.application(context), HListTypeHListPlus3.plus3)
,
t4.application(context), HListTypeHListPlus4.plus4)
,
t3.application(context), HListTypeHListPlus5.plus5)
,
t2.application(context), HListTypeHListPlus6.plus6)
,
t1.application(context), HListToTupleTypeHListPlus7.put7)
} else {
context.append[HListTypeHList6
[T1  , T2  , T3  , T4  , T5  , T6 ],
T7,
...
,
t7.application(context), HListToTupleTypeHListPlus7.plus7)
}
}
}
}
