...
trait BuildContent {
  ...
  def tuple1[T1](t1: T1): ContextContent[AsunaTuple1[T1]] =
  ...
  def nodeTuple1[T1](t1: ContextContent[T1]): ContextContent[AsunaTuple1[T1]] =
    new ContextContent[AsunaTuple1[T1]] {
      override def withContext[K <: KindContext](c: Context[K]): AsunaTuple1[T1] = {
        if (c.isReverse) {
  ...
  def tuple2[T1, T2](t1: T1, t2: T2): ContextContent[AsunaTuple2[T1, T2]] =
  ...
  def nodeTuple2[T1, T2](t1: ContextContent[T1], t2: ContextContent[T2]): ContextContent[AsunaTuple2[T1, T2]] =
    new ContextContent[AsunaTuple2[T1, T2]] {
      override def withContext[K <: KindContext](c: Context[K]): AsunaTuple2[T1, T2] = {
        if (c.isReverse) {
  ...
  def tuple3[T1, T2, T3](t1: T1, t2: T2, t3: T3): ContextContent[AsunaTuple3[T1, T2, T3]] =
  ...
  def nodeTuple3[T1, T2, T3](t1: ContextContent[T1], t2: ContextContent[T2], t3: ContextContent[T3]): ContextContent[AsunaTuple3[T1, T2, T3]] =
    new ContextContent[AsunaTuple3[T1, T2, T3]] {
      override def withContext[K <: KindContext](c: Context[K]): AsunaTuple3[T1, T2, T3] = {
        if (c.isReverse) {
  ...
  def tuple4[T1, T2, T3, T4](t1: T1, t2: T2, t3: T3, t4: T4): ContextContent[AsunaTuple4[T1, T2, T3, T4]] =
  ...
  def tuple5[T1, T2, T3, T4, T5](t1: T1, t2: T2, t3: T3, t4: T4, t5: T5): ContextContent[AsunaTuple5[T1, T2, T3, T4, T5]] =
  ...
  def tuple6[T1, T2, T3, T4, T5, T6](t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6): ContextContent[AsunaTuple6[T1, T2, T3, T4, T5, T6]] =
  ...
  def nodeTuple6[T1, T2, T3, T4, T5, T6](
    t1: ContextContent[T1],
    t2: ContextContent[T2],
    t3: ContextContent[T3],
    t4: ContextContent[T4],
  ...
  def tuple7[T1, T2, T3, T4, T5, T6, T7](t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7): ContextContent[AsunaTuple7[T1, T2, T3, T4, T5, T6, T7]] =
  ...
  def nodeTuple7[T1, T2, T3, T4, T5, T6, T7](
    t1: ContextContent[T1],
    t2: ContextContent[T2],
    t3: ContextContent[T3],
    t4: ContextContent[T4],
  ...
  def nodeTuple8[T1, T2, T3, T4, T5, T6, T7, T8](
    t1: ContextContent[T1],
    t2: ContextContent[T2],
    t3: ContextContent[T3],
    t4: ContextContent[T4],
