package asuna
import impl._
class NodeTag5[ T1 <: TupleTag , M1 <: Message  ,   T2 <: TupleTag , M2 <: Message  ,   T3 <: TupleTag , M3 <: Message  ,   T4 <: TupleTag , M4 <: Message  ,   T5 <: TupleTag , M5 <: Message  ] extends TupleTag {
...
object NodeTag5 {
implicit def noteTagApplicationImplicit5[K <: KindContext  , H1 <: TupleTag  , H2 <: TupleTag  , H3 <: TupleTag  , H4 <: TupleTag  , H5 <: TupleTag   , T1 <: TypeHList, M1 <: Message  , T2 <: TypeHList, M2 <: Message  , T3 <: TypeHList, M3 <: Message  , T4 <: TypeHList, M4 <: Message  , T5 <: TypeHList, M5 <: Message ]
