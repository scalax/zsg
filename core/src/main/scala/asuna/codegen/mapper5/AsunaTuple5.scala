...
trait AsunaTuple5[E1, E2, E3, E4, E5] extends Any {
  ...
  def leftTail: AsunaTuple4[E2, E3, E4, E5]               = throw new Exception("Can not use this method.")
  def rightHead: E5                                       = throw new Exception("Can not use this method.")
  def rightTail: AsunaTuple4[E1, E2, E3, E4]              = throw new Exception("Can not use this method.")
  def add[T](xyy: T): AsunaTuple6[E1, E2, E3, E4, E5, T]  = throw new Exception("Can not use this method.")
  def pull[T](xyy: T): AsunaTuple6[T, E1, E2, E3, E4, E5] = throw new Exception("Can not use this method.")
