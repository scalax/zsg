...
override def plus(p: HListTypeHList4[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#H,
item: AnyTypeHList#H): TupleTypeHList5[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#H = {
val ii1 = p.head
val tt1 = p.tail
val ii2 = tt1.head
val tt2 = tt1.tail
...
override def takeHead(t: AsunaTuple5[ AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ]):  AnyTypeHList#H ::  AnyTypeHList#H ::  AnyTypeHList#H ::  AnyTypeHList#H ::  HNil =  t.i4 ::  t.i3 ::  t.i2 ::  t.i1 ::  HNil
override lazy val sub: Plus[HListTypeHList4[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#T, AnyTypeHList#T, TupleTypeHList5[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#T] = plus5Any
}
...
override def takeHead(t: AsunaTuple5[ AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ,   AnyTypeHList#H  ]):  AnyTypeHList#H ::  AnyTypeHList#H ::  AnyTypeHList#H ::  AnyTypeHList#H ::  HNil =  t.i2 ::  t.i3 ::  t.i4 ::  t.i5 ::  HNil
override lazy val sub: Plus[HListTypeHList4[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#T, AnyTypeHList#T, TupleTypeHList5[ AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ,   AnyTypeHList  ]#T] = put5Any
}
