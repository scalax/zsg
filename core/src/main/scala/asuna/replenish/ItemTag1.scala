...
class ItemTag1[T1, M1 <: Message] extends ItemTag {
  override type ItemType = AsunaTuple1[T1]
  import impl._
  ...
  ): Application[K, ItemTag1[T1, Message], TupleTypeHList1[I1]] =
...
object ItemTag1 {
  ...
  ): Application[K, ItemTag1[H1, M1], TupleTypeHList1[T1]] =
    new Application[K, ItemTag1[H1, M1], TupleTypeHList1[T1]] {
