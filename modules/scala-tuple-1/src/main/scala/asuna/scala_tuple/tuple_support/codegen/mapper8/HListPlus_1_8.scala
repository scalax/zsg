...
trait HListPlus_1_8 {
  final def plusWithTypeParameter1[X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X6_C1, X7_C1, X8_C1, Y1, Y2, Y3, Y4, Y5, Y6, Y7, Y8]: Plus8[
    ...
    new Plus8[
      ...
      final override def takeHead7(z: Y7 :: X7_C1 :: HNil): X7_C1 :: HNil    = z.tail
      final override def takeTail7(z: Y7 :: X7_C1 :: HNil): Y7               = z.head
      final override def plus7(x: X7_C1 :: HNil, y: Y7): Y7 :: X7_C1 :: HNil = x.::(y)
      final override def takeHead8(z: Y8 :: X8_C1 :: HNil): X8_C1 :: HNil    = z.tail
      final override def takeTail8(z: Y8 :: X8_C1 :: HNil): Y8               = z.head
      final override def plus8(x: X8_C1 :: HNil, y: Y8): Y8 :: X8_C1 :: HNil = x.::(y)
    }
}
