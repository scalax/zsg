...
trait PlusToTuple_1_8 {
        final def plus8WithTypeParameter1[
            Plus1_X1,
            Plus2_X1,
            Plus3_X1,
            Plus4_X1,
            ...
            AsunaTuple1[Plus7_X1],
            AsunaTuple1[Plus8_X1],
            ...
            Tuple1[Plus8_X1]
                ...
                final override def plus6(x: AsunaTuple1[Plus6_X1], y: AsunaTuple0): Tuple1[Plus6_X1] =
                    Tuple1(x.i1)
                final override def takeHead7(z: Tuple1[Plus7_X1]): AsunaTuple1[Plus7_X1] =
                    BuildContent.tuple1(z._1)
                final override def takeTail7(z: Tuple1[Plus7_X1]): AsunaTuple0 = AsunaTuple0.value
                final override def plus7(x: AsunaTuple1[Plus7_X1], y: AsunaTuple0): Tuple1[Plus7_X1] =
                    Tuple1(x.i1)
                final override def takeHead8(z: Tuple1[Plus8_X1]): AsunaTuple1[Plus8_X1] =
                    BuildContent.tuple1(z._1)
                final override def takeTail8(z: Tuple1[Plus8_X1]): AsunaTuple0 = AsunaTuple0.value
                final override def plus8(x: AsunaTuple1[Plus8_X1], y: AsunaTuple0): Tuple1[Plus8_X1] =
                    Tuple1(x.i1)
        }
}
