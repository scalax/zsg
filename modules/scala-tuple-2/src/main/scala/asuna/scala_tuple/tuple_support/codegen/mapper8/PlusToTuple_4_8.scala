...
(y  , x  .head  , x  .tail  .head  , x  .tail  .tail  .head  , x  .tail  .tail  .tail  .head )
final override def takeHead8(z: ( Y8  , X8_C1  , X8_C2  , X8_C3  , X8_C4  )):  X8_C1 ::  X8_C2 ::  X8_C3 ::  X8_C4 ::  HNil =
z._2 ::  z._3 ::  z._4 ::  z._5 ::  HNil.value
final override def takeTail8(z: ( Y8  , X8_C1  , X8_C2  , X8_C3  , X8_C4  )): Y8 = z._1
final override def plus8(x:  X8_C1 ::  X8_C2 ::  X8_C3 ::  X8_C4 ::  HNil, y: Y8): ( Y8  , X8_C1  , X8_C2  , X8_C3  , X8_C4  ) =
(y  , x  .head  , x  .tail  .head  , x  .tail  .tail  .head  , x  .tail  .tail  .tail  .head )
}
}
