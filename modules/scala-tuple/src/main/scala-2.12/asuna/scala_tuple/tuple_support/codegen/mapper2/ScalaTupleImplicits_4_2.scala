...
trait ScalaTupleImplicits_4_2 {
        ...
        Tuple4[Plus2_X1 , Plus2_X2 , Plus2_X3 , Plus2_X4]
            ...
            Tuple4[Plus2_X1 , Plus2_X2 , Plus2_X3 , Plus2_X4]
                ...
                val asunaTuple2F = Application2.lift(BuildTag.nodeTag(BuildTag.tag(AppendTag[Tag1] , AppendTag[Tag2]) , BuildTag.tag(AppendTag[Tag3] , AppendTag[Tag4]))).application(context)
