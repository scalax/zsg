...
trait ScalaTupleImplicits_2_2 {
    ...
    t1: Application2[F, Tag1, Plus1_X1 , Plus2_X1] , t2: Application2[F, Tag2, Plus1_X2 , Plus2_X2]): Application2[
        ...
        override def application(context: Context2[F]): F[
            ...
            val asunaTuple2F = Application2.lift(BuildTag.tag(AppendTag[Tag1] , AppendTag[Tag2])).application(context)
            context.append(asunaTuple2F, context.start)(PlusToTuple2.plus2WithTypeParameter2)
        }
    }
}
