...
inline def hlistTagApplicationImplicit_tagNum4_typeParamNum6[
F[_  , _  , _  , _  , _  , _ ]
, H1  , H2  , H3  , H4
...
: Application6[
F,
H1 ::  H2 ::  H3 ::  H4 ::  HNil  ,  X1_C1 ::  X2_C1 ::  X3_C1 ::  X4_C1 ::  HNil  ,  X1_C2 ::  X2_C2 ::  X3_C2 ::  X4_C2 ::  HNil  ,  X1_C3 ::  X2_C3 ::  X3_C3 ::  X4_C3 ::  HNil  ,  X1_C4 ::  X2_C4 ::  X3_C4 ::  X4_C4 ::  HNil  ,  X1_C5 ::  X2_C5 ::  X3_C5 ::  X4_C5 ::  HNil  ,  X1_C6 ::  X2_C6 ::  X3_C6 ::  X4_C6 ::  HNil ] =
new Application6[
F,
H1 ::  H2 ::  H3 ::  H4 ::  HNil  ,  X1_C1 ::  X2_C1 ::  X3_C1 ::  X4_C1 ::  HNil  ,  X1_C2 ::  X2_C2 ::  X3_C2 ::  X4_C2 ::  HNil  ,  X1_C3 ::  X2_C3 ::  X3_C3 ::  X4_C3 ::  HNil  ,  X1_C4 ::  X2_C4 ::  X3_C4 ::  X4_C4 ::  HNil  ,  X1_C5 ::  X2_C5 ::  X3_C5 ::  X4_C5 ::  HNil  ,  X1_C6 ::  X2_C6 ::  X3_C6 ::  X4_C6 ::  HNil ] {
override def application(context: Context6[F]) = {
context.append(
ScalaTupleImplicits_3_6.hlistTagApplicationImplicit_tagNum3_typeParamNum6(t2  , t3  , t4 ).application(context),
