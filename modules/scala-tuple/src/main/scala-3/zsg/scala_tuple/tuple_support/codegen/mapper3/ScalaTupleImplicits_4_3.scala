...
trait ScalaTupleImplicits_4_3 {
         inline given  [
            ...
            override def application(context: T) = {
                context.append(ApplicationFetchContent.app3[F, T, zsg.ZTuple4[Plus1_X1 , Plus1_X2 , Plus1_X3 , Plus1_X4] , zsg.ZTuple4[Plus2_X1 , Plus2_X2 , Plus2_X3 , Plus2_X4] , zsg.ZTuple4[Plus3_X1 , Plus3_X2 , Plus3_X3 , Plus3_X4]].application(context), context.start)(PlusToTuple3.plus3WithTypeParameter4)
            }
        }
}
