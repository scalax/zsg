...
trait ScalaTupleImplicits_11_1 {
         inline given  [
            ...
            override def application(context: T) = {
                context.append(ApplicationFetchContent.app1[F, T, zsg.ZTuple11[Plus1_X1 , Plus1_X2 , Plus1_X3 , Plus1_X4 , Plus1_X5 , Plus1_X6 , Plus1_X7 , Plus1_X8 , Plus1_X9 , Plus1_X10 , Plus1_X11]].application(context), context.start)(PlusToTuple1.plus1WithTypeParameter11)
            }
        }
}
