    ...
    override def application(context: T) = {
      context.append(
        ApplicationFetchContent
          .app5[F, T, zsg.ZTuple4[Plus1_X1, Plus1_X2, Plus1_X3, Plus1_X4], zsg.ZTuple4[Plus2_X1, Plus2_X2, Plus2_X3, Plus2_X4], zsg.ZTuple4[
            Plus3_X1,
            Plus3_X2,
            Plus3_X3,
            Plus3_X4
          ], zsg.ZTuple4[Plus4_X1, Plus4_X2, Plus4_X3, Plus4_X4], zsg.ZTuple4[Plus5_X1, Plus5_X2, Plus5_X3, Plus5_X4]]
          .application(context),
        context.start
      )(PlusToTuple5.plus5WithTypeParameter4)
    }
  }
}
