      ...
      override def application(context: T) = {
        context.append(
          ApplicationFetchContent
            .app6[F, T, zsg.ZTuple3[Plus1_X1, Plus1_X2, Plus1_X3], zsg.ZTuple3[Plus2_X1, Plus2_X2, Plus2_X3], zsg.ZTuple3[Plus3_X1, Plus3_X2, Plus3_X3], zsg.ZTuple3[
              Plus4_X1,
              Plus4_X2,
              Plus4_X3
            ], zsg.ZTuple3[Plus5_X1, Plus5_X2, Plus5_X3], zsg.ZTuple3[Plus6_X1, Plus6_X2, Plus6_X3]]
            .application(context),
          context.start
        )(PlusToTuple6.plus6WithTypeParameter3)
      }
    }
}
