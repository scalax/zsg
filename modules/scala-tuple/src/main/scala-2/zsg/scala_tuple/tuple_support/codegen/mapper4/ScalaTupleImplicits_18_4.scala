...
trait ScalaTupleImplicits_18_4 {
         implicit def  tupleTagApplicationImplicit_tagNum18_typeParamNum4[
            ...
            context.append(implicitApplication.application, context.start)(PlusToTuple4.plus4WithTypeParameter18)
        })
}
