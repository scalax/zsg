...
trait ScalaTupleImplicits_22_5 {
  implicit def tupleTagApplicationImplicit_tagNum22_typeParamNum5[
    ...
    t21: F[Plus1_X21, Plus2_X21, Plus3_X21, Plus4_X21, Plus5_X21],
    t22: F[Plus1_X22, Plus2_X22, Plus3_X22, Plus4_X22, Plus5_X22]
  ): ApplicationX5[
    F,
    T,
    Tuple22[
    ...
    override def application(context: T) = {
      context.append(
        ApplicationFetchContent
          ...
          .application(context),
        context.start
      )(PlusToTuple5.plus5WithTypeParameter22)
    }
  }
}
