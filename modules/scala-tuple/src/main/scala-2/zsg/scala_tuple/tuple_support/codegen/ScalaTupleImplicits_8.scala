...
trait ScalaTupleImplicits_8 {
  implicit def contextNum_1_8[F[_], T <: zsg.Context1[
    F
    ...
    Tuple7_Context1,
    Tuple8_Context1
  ]] = new zsg.ApplicationX1[F, T, Tuple8[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t8
      )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum1)
    }
  }
  implicit def contextNum_2_8[F[_, _], T <: zsg.Context2[
    F
    ...
    new zsg.ApplicationX2[F, T, Tuple8[
      Tuple1_Context1,
      Tuple2_Context1,
      Tuple3_Context1,
      Tuple4_Context1,
      ...
      override def application(context: T): F[
        ...
        context.append(
          ...
          t8
        )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum2)
      }
    }
  implicit def contextNum_3_8[F[_, _, _], T <: zsg.Context3[
    F
    ...
    Tuple7_Context1,
    Tuple8_Context1
  ], Tuple8[Tuple1_Context2, Tuple2_Context2, Tuple3_Context2, Tuple4_Context2, Tuple5_Context2, Tuple6_Context2, Tuple7_Context2, Tuple8_Context2], Tuple8[
    Tuple1_Context3,
    Tuple2_Context3,
    Tuple3_Context3,
    Tuple4_Context3,
    ...
    Tuple7_Context3,
    Tuple8_Context3
  ]] = new zsg.ApplicationX3[F, T, Tuple8[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t8
      )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum3)
    }
  }
  implicit def contextNum_4_8[F[_, _, _, _], T <: zsg.Context4[
    F
    ...
    new zsg.ApplicationX4[F, T, Tuple8[
      Tuple1_Context1,
      Tuple2_Context1,
      Tuple3_Context1,
      Tuple4_Context1,
      ...
      override def application(context: T): F[
        ...
        context.append(
          ...
          t8
        )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum4)
      }
    }
  implicit def contextNum_5_8[F[_, _, _, _, _], T <: zsg.Context5[
    F
    ...
    Tuple7_Context3,
    Tuple8_Context3
  ], Tuple8[Tuple1_Context4, Tuple2_Context4, Tuple3_Context4, Tuple4_Context4, Tuple5_Context4, Tuple6_Context4, Tuple7_Context4, Tuple8_Context4], Tuple8[
    Tuple1_Context5,
    Tuple2_Context5,
    Tuple3_Context5,
    Tuple4_Context5,
    ...
    Tuple7_Context5,
    Tuple8_Context5
  ]] = new zsg.ApplicationX5[F, T, Tuple8[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t8
      )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum5)
    }
  }
  implicit def contextNum_6_8[F[_, _, _, _, _, _], T <: zsg.Context6[
    F
    ...
    new zsg.ApplicationX6[F, T, Tuple8[
      Tuple1_Context1,
      Tuple2_Context1,
      Tuple3_Context1,
      Tuple4_Context1,
      ...
      override def application(context: T): F[
        ...
        context.append(
          ...
          t8
        )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum6)
      }
    }
  implicit def contextNum_7_8[F[_, _, _, _, _, _, _], T <: zsg.Context7[
    F
    ...
    Tuple7_Context5,
    Tuple8_Context5
  ], Tuple8[Tuple1_Context6, Tuple2_Context6, Tuple3_Context6, Tuple4_Context6, Tuple5_Context6, Tuple6_Context6, Tuple7_Context6, Tuple8_Context6], Tuple8[
    Tuple1_Context7,
    Tuple2_Context7,
    Tuple3_Context7,
    Tuple4_Context7,
    ...
    Tuple7_Context7,
    Tuple8_Context7
  ]] = new zsg.ApplicationX7[F, T, Tuple8[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t8
      )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum7)
    }
  }
  implicit def contextNum_8_8[F[_, _, _, _, _, _, _, _], T <: zsg.Context8[
    F
    ...
    new zsg.ApplicationX8[F, T, Tuple8[
      Tuple1_Context1,
      Tuple2_Context1,
      Tuple3_Context1,
      Tuple4_Context1,
      ...
      override def application(context: T): F[
        ...
        context.append(
          ...
          t8
        )(zsg.scala_tuple.tuple_support.PlusInstanceScalaTuple_8.contextNum8)
      }
    }
}
