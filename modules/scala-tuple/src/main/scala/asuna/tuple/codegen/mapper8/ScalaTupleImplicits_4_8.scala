...
trait ScalaTupleImplicits_4_8 {
  final implicit def tupleTagApplicationImplicit_tagNum4_typeParamNum8[
    ...
    (X1_C8, X2_C8, X3_C8, X4_C8)
  ] = { context: Context8[F] =>
    context.append(
      context.append(context.append(t4.application(context), t3.application(context))(HListPlus8.plusWithTypeParameter1), t2.application(context))(
