...
trait ScalaTupleImplicits_4_2 {
  ...
  ): Application2[F, (H1, H2, H3, H4), (X1_C1, X2_C1, X3_C1, X4_C1), (X1_C2, X2_C2, X3_C2, X4_C2)] = { context: Context2[F] =>
    context.append(
      context.append(context.append(t4.application(context), t3.application(context))(HListPlus2.plusWithTypeParameter1), t2.application(context))(
