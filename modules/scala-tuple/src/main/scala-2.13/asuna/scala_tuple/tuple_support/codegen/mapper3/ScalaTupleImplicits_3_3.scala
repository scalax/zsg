...
trait ScalaTupleImplicits_3_3 {
  ...
  ): Application3[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil, X1_C2 :: X2_C2 :: X3_C2 :: HNil, X1_C3 :: X2_C3 :: X3_C3 :: HNil] =
    new Application3[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil, X1_C2 :: X2_C2 :: X3_C2 :: HNil, X1_C3 :: X2_C3 :: X3_C3 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum3_typeParamNum3[
    ...
    t2: Application3[F, H2, X2_C1, X2_C2, X2_C3],
    t3: Application3[F, H3, X3_C1, X3_C2, X3_C3]
  ): Application3[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1), (X1_C2, X2_C2, X3_C2), (X1_C3, X2_C3, X3_C3)] =
    new Application3[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1), (X1_C2, X2_C2, X3_C2), (X1_C3, X2_C3, X3_C3)] {
      override def application(context: Context3[F]) = {
        context.append(
          ScalaTupleImplicits_2_3.hlistTagApplicationImplicit_tagNum2_typeParamNum3(t2, t3).application(context),
          t1.application(context)
