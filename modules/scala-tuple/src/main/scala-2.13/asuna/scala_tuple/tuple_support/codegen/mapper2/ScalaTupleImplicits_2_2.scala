...
trait ScalaTupleImplicits_2_2 {
  def hlistTagApplicationImplicit_tagNum2_typeParamNum2[
    ...
    X2_C1,
    X2_C2
  ](t1: Application2[F, H1, X1_C1, X1_C2], t2: Application2[F, H2, X2_C1, X2_C2]): Application2[F, H1 :: H2 :: HNil, X1_C1 :: X2_C1 :: HNil, X1_C2 :: X2_C2 :: HNil] =
    new Application2[F, H1 :: H2 :: HNil, X1_C1 :: X2_C1 :: HNil, X1_C2 :: X2_C2 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum2_typeParamNum2[
    ...
    X2_C1,
    X2_C2
  ](implicit t1: Application2[F, H1, X1_C1, X1_C2], t2: Application2[F, H2, X2_C1, X2_C2]): Application2[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2)] =
    new Application2[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2)] {
      override def application(context: Context2[F]) = {
