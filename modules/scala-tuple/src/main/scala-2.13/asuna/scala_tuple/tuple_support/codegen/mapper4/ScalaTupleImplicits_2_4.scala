...
trait ScalaTupleImplicits_2_4 {
  def hlistTagApplicationImplicit_tagNum2_typeParamNum4[
    F[_, _, _, _],
    H1,
    H2,
    X1_C1,
  ...
  ): Application4[F, H1 :: H2 :: HNil, X1_C1 :: X2_C1 :: HNil, X1_C2 :: X2_C2 :: HNil, X1_C3 :: X2_C3 :: HNil, X1_C4 :: X2_C4 :: HNil] =
    new Application4[F, H1 :: H2 :: HNil, X1_C1 :: X2_C1 :: HNil, X1_C2 :: X2_C2 :: HNil, X1_C3 :: X2_C3 :: HNil, X1_C4 :: X2_C4 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum2_typeParamNum4[
    ...
    t2: Application4[F, H2, X2_C1, X2_C2, X2_C3, X2_C4]
  ): Application4[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2), (X1_C3, X2_C3), (X1_C4, X2_C4)] =
    new Application4[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2), (X1_C3, X2_C3), (X1_C4, X2_C4)] {
      override def application(context: Context4[F]) = {
