...
trait ScalaTupleImplicits_11_4 {
  def hlistTagApplicationImplicit_tagNum11_typeParamNum4[
    F[_, _, _, _],
    H1,
    H2,
    H3,
    ...
    X1_C4 :: X2_C4 :: X3_C4 :: X4_C4 :: X5_C4 :: X6_C4 :: X7_C4 :: X8_C4 :: X9_C4 :: X10_C4 :: X11_C4 :: HNil
  ] =
    new Application4[
      F,
      H1 :: H2 :: H3 :: H4 :: H5 :: H6 :: H7 :: H8 :: H9 :: H10 :: H11 :: HNil,
      ...
      override def application(context: Context4[F]) = {
        context.append(
          ScalaTupleImplicits_10_4.hlistTagApplicationImplicit_tagNum10_typeParamNum4(t2, t3, t4, t5, t6, t7, t8, t9, t10, t11).application(context),
