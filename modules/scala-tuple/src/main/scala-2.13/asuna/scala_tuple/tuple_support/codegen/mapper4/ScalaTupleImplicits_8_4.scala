...
trait ScalaTupleImplicits_8_4 {
  def hlistTagApplicationImplicit_tagNum8_typeParamNum4[
    F[_, _, _, _],
    H1,
    H2,
    H3,
    ...
    new Application4[
      ...
      override def application(context: Context4[F]) = {
        context.append(
          ScalaTupleImplicits_7_4.hlistTagApplicationImplicit_tagNum7_typeParamNum4(t2, t3, t4, t5, t6, t7, t8).application(context),
