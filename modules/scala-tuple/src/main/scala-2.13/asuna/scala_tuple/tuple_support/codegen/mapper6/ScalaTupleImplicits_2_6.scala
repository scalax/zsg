...
trait ScalaTupleImplicits_2_6 {
  def hlistTagApplicationImplicit_tagNum2_typeParamNum6[
    ...
    X2_C5,
    X2_C6
  ](t1: Application6[F, H1, X1_C1, X1_C2, X1_C3, X1_C4, X1_C5, X1_C6], t2: Application6[F, H2, X2_C1, X2_C2, X2_C3, X2_C4, X2_C5, X2_C6]): Application6[
    F,
    H1 :: H2 :: HNil,
    X1_C1 :: X2_C1 :: HNil,
    X1_C2 :: X2_C2 :: HNil,
  ...
  ): Application6[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2), (X1_C3, X2_C3), (X1_C4, X2_C4), (X1_C5, X2_C5), (X1_C6, X2_C6)] =
    new Application6[F, (H1, H2), (X1_C1, X2_C1), (X1_C2, X2_C2), (X1_C3, X2_C3), (X1_C4, X2_C4), (X1_C5, X2_C5), (X1_C6, X2_C6)] {
      override def application(context: Context6[F]) = {
