...
trait ScalaTupleImplicits_16_4 {
  implicit def tupleTagApplicationImplicit_tagNum16_typeParamNum4[
    ...
    t16: Application4[F, H16, X16_C1, X16_C2, X16_C3, X16_C4]
  ): Application4[
    F,
    ...
    (X1_C4, X2_C4, X3_C4, X4_C4, X5_C4, X6_C4, X7_C4, X8_C4, X9_C4, X10_C4, X11_C4, X12_C4, X13_C4, X14_C4, X15_C4, X16_C4)
  ] =
    new Application4[
      F,
      (H1, H2, H3, H4, H5, H6, H7, H8, H9, H10, H11, H12, H13, H14, H15, H16),
      ...
      override def application(context: Context4[F]) = {
        context.append(
          ScalaTupleImplicits_15_4
            .hlistTagApplicationImplicit_tagNum15_typeParamNum4(t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16)
            .application(context),
