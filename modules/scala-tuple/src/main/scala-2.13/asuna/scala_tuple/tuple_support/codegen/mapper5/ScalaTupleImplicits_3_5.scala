...
trait ScalaTupleImplicits_3_5 {
  def hlistTagApplicationImplicit_tagNum3_typeParamNum5[
    F[_, _, _, _, _],
    H1,
    H2,
    H3,
    ...
    new Application5[
      ...
      override def application(context: Context5[F]) = {
        context.append(
          ScalaTupleImplicits_2_5.hlistTagApplicationImplicit_tagNum2_typeParamNum5(t2, t3).application(context),
  ...
  implicit def tupleTagApplicationImplicit_tagNum3_typeParamNum5[
    ...
    new Application5[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1), (X1_C2, X2_C2, X3_C2), (X1_C3, X2_C3, X3_C3), (X1_C4, X2_C4, X3_C4), (X1_C5, X2_C5, X3_C5)] {
      override def application(context: Context5[F]) = {
        context.append(
          ScalaTupleImplicits_2_5.hlistTagApplicationImplicit_tagNum2_typeParamNum5(t2, t3).application(context),
          t1.application(context)
