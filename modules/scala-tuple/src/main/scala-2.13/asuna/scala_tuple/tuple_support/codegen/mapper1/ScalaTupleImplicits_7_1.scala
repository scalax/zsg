...
trait ScalaTupleImplicits_7_1 {
  ...
  ): Application1[F, H1 :: H2 :: H3 :: H4 :: H5 :: H6 :: H7 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: X4_C1 :: X5_C1 :: X6_C1 :: X7_C1 :: HNil] =
    new Application1[F, H1 :: H2 :: H3 :: H4 :: H5 :: H6 :: H7 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: X4_C1 :: X5_C1 :: X6_C1 :: X7_C1 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum7_typeParamNum1[
    ...
    t6: Application1[F, H6, X6_C1],
    t7: Application1[F, H7, X7_C1]
  ): Application1[F, (H1, H2, H3, H4, H5, H6, H7), (X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X6_C1, X7_C1)] =
    new Application1[F, (H1, H2, H3, H4, H5, H6, H7), (X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X6_C1, X7_C1)] {
      override def application(context: Context1[F]) = {
        context.append(
          ScalaTupleImplicits_6_1.hlistTagApplicationImplicit_tagNum6_typeParamNum1(t2, t3, t4, t5, t6, t7).application(context),
          t1.application(context)
