...
trait ScalaTupleImplicits_3_1 {
  def hlistTagApplicationImplicit_tagNum3_typeParamNum1[
    F[_],
    H1,
    H2,
    H3,
  ...
  ): Application1[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil] =
    new Application1[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum3_typeParamNum1[
    ...
    X2_C1,
    X3_C1
  ](implicit t1: Application1[F, H1, X1_C1], t2: Application1[F, H2, X2_C1], t3: Application1[F, H3, X3_C1]): Application1[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1)] =
    new Application1[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1)] {
      override def application(context: Context1[F]) = {
        context.append(
          ScalaTupleImplicits_2_1.hlistTagApplicationImplicit_tagNum2_typeParamNum1(t2, t3).application(context),
          t1.application(context)
