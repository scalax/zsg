...
trait ScalaTupleImplicits_7_2 {
  ...
  implicit def tupleTagApplicationImplicit_tagNum7_typeParamNum2[
    ...
    t6: Application2[F, H6, X6_C1, X6_C2],
    t7: Application2[F, H7, X7_C1, X7_C2]
  ): Application2[F, (H1, H2, H3, H4, H5, H6, H7), (X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X6_C1, X7_C1), (X1_C2, X2_C2, X3_C2, X4_C2, X5_C2, X6_C2, X7_C2)] =
    new Application2[F, (H1, H2, H3, H4, H5, H6, H7), (X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X6_C1, X7_C1), (X1_C2, X2_C2, X3_C2, X4_C2, X5_C2, X6_C2, X7_C2)] {
      override def application(context: Context2[F]) = {
        context.append(
          ScalaTupleImplicits_6_2.hlistTagApplicationImplicit_tagNum6_typeParamNum2(t2, t3, t4, t5, t6, t7).application(context),
          t1.application(context)
