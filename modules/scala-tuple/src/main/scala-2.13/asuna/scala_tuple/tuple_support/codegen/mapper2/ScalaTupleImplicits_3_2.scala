...
trait ScalaTupleImplicits_3_2 {
  def hlistTagApplicationImplicit_tagNum3_typeParamNum2[
    F[_, _],
    H1,
    H2,
    H3,
  ...
  ): Application2[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil, X1_C2 :: X2_C2 :: X3_C2 :: HNil] =
    new Application2[F, H1 :: H2 :: H3 :: HNil, X1_C1 :: X2_C1 :: X3_C1 :: HNil, X1_C2 :: X2_C2 :: X3_C2 :: HNil] {
  ...
  implicit def tupleTagApplicationImplicit_tagNum3_typeParamNum2[
    ...
    t2: Application2[F, H2, X2_C1, X2_C2],
    t3: Application2[F, H3, X3_C1, X3_C2]
  ): Application2[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1), (X1_C2, X2_C2, X3_C2)] =
    new Application2[F, (H1, H2, H3), (X1_C1, X2_C1, X3_C1), (X1_C2, X2_C2, X3_C2)] {
      override def application(context: Context2[F]) = {
        context.append(
          ScalaTupleImplicits_2_2.hlistTagApplicationImplicit_tagNum2_typeParamNum2(t2, t3).application(context),
          t1.application(context)
