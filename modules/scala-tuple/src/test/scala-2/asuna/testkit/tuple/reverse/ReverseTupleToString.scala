...
object ReverseAppendTuple {
  ...
  implicit def reverseApplicationImplicit[T](implicit t: ReverseTupleEncoder[T]): Application1[ReverseTupleEncoder, T, T] = new Application1[ReverseTupleEncoder, T, T] {
