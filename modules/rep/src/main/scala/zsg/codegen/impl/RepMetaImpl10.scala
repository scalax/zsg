...
class RepMetaImpl10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10](
...
) extends zsg.rep.RepMeta10(rep1 = rep1, rep2 = rep2, rep3 = rep3, rep4 = rep4, rep5 = rep5, rep6 = rep6, rep7 = rep7, rep8 = rep8, rep9 = rep9, rep10 = rep10) {
  override def rep[Tu1, Out_1_1, Out_1_2, Out_1_3, Out_1_4, Out_1_5, Out_1_6, Out_1_7, Out_1_8, Out_1_9, Out_1_10](
    tuple: Tu1
  )(implicit
