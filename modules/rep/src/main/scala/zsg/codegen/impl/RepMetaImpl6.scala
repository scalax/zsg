...
class RepMetaImpl6[T1, T2, T3, T4, T5, T6](
...
) extends zsg.rep.RepMeta6(rep1 = rep1, rep2 = rep2, rep3 = rep3, rep4 = rep4, rep5 = rep5, rep6 = rep6) {
  override def rep[Tu1, Out_1_1, Out_1_2, Out_1_3, Out_1_4, Out_1_5, Out_1_6](tuple: Tuple1[Tu1])(implicit
  ...
  override def rep[Tu1, Tu2, Out_1_1, Out_1_2, Out_1_3, Out_1_4, Out_1_5, Out_1_6, Out_2_1, Out_2_2, Out_2_3, Out_2_4, Out_2_5, Out_2_6](tuple: Tuple2[Tu1, Tu2])(implicit
    repFunction_1_1: zsg.rep.RepFunction[T1, Tu1, Out_1_1],
    repFunction_2_1: zsg.rep.RepFunction[T2, Tu1, Out_1_2],
    repFunction_3_1: zsg.rep.RepFunction[T3, Tu1, Out_1_3],
    repFunction_4_1: zsg.rep.RepFunction[T4, Tu1, Out_1_4],
