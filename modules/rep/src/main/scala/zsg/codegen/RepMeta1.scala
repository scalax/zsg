...
abstract class RepMeta1[T1](val rep1: T1) {
  def rep[Tu1, Out_1_1](tuple: Tuple1[Tu1])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1]
  ): RepMeta1[Out_1_1]
  def rep[Tu1, Tu2, Out_1_1, Out_2_1](tuple: Tuple2[Tu1, Tu2])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1]
  ): RepMeta1[Out_2_1]
  def rep[Tu1, Tu2, Tu3, Out_1_1, Out_2_1, Out_3_1](tuple: Tuple3[Tu1, Tu2, Tu3])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1],
    repFunction_1_3: RepFunction[Out_2_1, Tu3, Out_3_1]
  ): RepMeta1[Out_3_1]
  def rep[Tu1, Tu2, Tu3, Tu4, Out_1_1, Out_2_1, Out_3_1, Out_4_1](tuple: Tuple4[Tu1, Tu2, Tu3, Tu4])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1],
    repFunction_1_3: RepFunction[Out_2_1, Tu3, Out_3_1],
    repFunction_1_4: RepFunction[Out_3_1, Tu4, Out_4_1]
  ): RepMeta1[Out_4_1]
  def rep[Tu1, Tu2, Tu3, Tu4, Tu5, Out_1_1, Out_2_1, Out_3_1, Out_4_1, Out_5_1](tuple: Tuple5[Tu1, Tu2, Tu3, Tu4, Tu5])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1],
    repFunction_1_3: RepFunction[Out_2_1, Tu3, Out_3_1],
    repFunction_1_4: RepFunction[Out_3_1, Tu4, Out_4_1],
  ...
  def rep[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6, Out_1_1, Out_2_1, Out_3_1, Out_4_1, Out_5_1, Out_6_1](tuple: Tuple6[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1],
    repFunction_1_3: RepFunction[Out_2_1, Tu3, Out_3_1],
    repFunction_1_4: RepFunction[Out_3_1, Tu4, Out_4_1],
  ...
  def rep[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6, Tu7, Out_1_1, Out_2_1, Out_3_1, Out_4_1, Out_5_1, Out_6_1, Out_7_1](tuple: Tuple7[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6, Tu7])(implicit
    repFunction_1_1: RepFunction[T1, Tu1, Out_1_1],
    repFunction_1_2: RepFunction[Out_1_1, Tu2, Out_2_1],
    repFunction_1_3: RepFunction[Out_2_1, Tu3, Out_3_1],
    repFunction_1_4: RepFunction[Out_3_1, Tu4, Out_4_1],
  ...
  def rep[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6, Tu7, Tu8, Out_1_1, Out_2_1, Out_3_1, Out_4_1, Out_5_1, Out_6_1, Out_7_1, Out_8_1](
  ...
  def rep[Tu1, Tu2, Tu3, Tu4, Tu5, Tu6, Tu7, Tu8, Tu9, Out_1_1, Out_2_1, Out_3_1, Out_4_1, Out_5_1, Out_6_1, Out_7_1, Out_8_1, Out_9_1](
