...
trait DebugCaseClass14Instance {
        given zsgTupleToDebugCaseClass14InstanceImplicit[D1 , D2 , D3 , D4 , D5 , D6 , D7 , D8 , D9 , D10 , D11 , D12 , D13 , D14] as ZsgTupleToDebugCaseClass[
            ...
            override def tupleToCaseClass(tuple: zsg.ZTuple14[D1 , D2 , D3 , D4 , D5 , D6 , D7 , D8 , D9 , D10 , D11 , D12 , D13 , D14]
            ): DebugCaseClass14[D1 , D2 , D3 , D4 , D5 , D6 , D7 , D8 , D9 , D10 , D11 , D12 , D13 , D14] = {
                DebugCaseClass14(d1 = tuple.i1 , d2 = tuple.i2 , d3 = tuple.i3 , d4 = tuple.i4 , d5 = tuple.i5 , d6 = tuple.i6 , d7 = tuple.i7 , d8 = tuple.i8 , d9 = tuple.i9 , d10 = tuple.i10 , d11 = tuple.i11 , d12 = tuple.i12 , d13 = tuple.i13 , d14 = tuple.i14)
            }
        }
}
