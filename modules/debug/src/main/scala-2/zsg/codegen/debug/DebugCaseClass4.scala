...
trait DebugCaseClass4Instance {
  implicit def zsgTupleToDebugCaseClass4InstanceImplicit[D1, D2, D3, D4]: ZsgTupleToDebugCaseClass[
    ...
    override def tupleToCaseClass(tuple: zsg.ZTuple4[D1, D2, D3, D4]): DebugCaseClass4[D1, D2, D3, D4] = {
...
case class DebugCaseClass4[D1, D2, D3, D4](d1: D1, d2: D2, d3: D3, d4: D4) {
  def infer(implicit d1: D1, d2: D2, d3: D3, d4: D4): DebugCaseClass4[D1, D2, D3, D4] = {
