...
trait DebugCaseClass11Instance {
  implicit def zsgTupleToDebugCaseClass11InstanceImplicit[D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11]: ZsgTupleToDebugCaseClass[
    ...
    override def tupleToCaseClass(tuple: zsg.ZTuple11[D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11]): DebugCaseClass11[D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11] = {
      DebugCaseClass11(
        d1 = tuple.i1,
        d2 = tuple.i2,
        d3 = tuple.i3,
...
case class DebugCaseClass11[D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11](d1: D1, d2: D2, d3: D3, d4: D4, d5: D5, d6: D6, d7: D7, d8: D8, d9: D9, d10: D10, d11: D11) {
  def infer(implicit d1: D1, d2: D2, d3: D3, d4: D4, d5: D5, d6: D6, d7: D7, d8: D8, d9: D9, d10: D10, d11: D11)
    : DebugCaseClass11[D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11] = {
