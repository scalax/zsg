...
trait DebugCaseClass7Instance {
  implicit def zsgTupleToDebugCaseClass7InstanceImplicit[D1, D2, D3, D4, D5, D6, D7]: ZsgTupleToDebugCaseClass[
    ...
    override def tupleToCaseClass(tuple: zsg.ZTuple7[D1, D2, D3, D4, D5, D6, D7]): DebugCaseClass7[D1, D2, D3, D4, D5, D6, D7] = {
...
case class DebugCaseClass7[D1, D2, D3, D4, D5, D6, D7](d1: D1, d2: D2, d3: D3, d4: D4, d5: D5, d6: D6, d7: D7) {
  def infer(implicit d1: D1, d2: D2, d3: D3, d4: D4, d5: D5, d6: D6, d7: D7): DebugCaseClass7[D1, D2, D3, D4, D5, D6, D7] = {
