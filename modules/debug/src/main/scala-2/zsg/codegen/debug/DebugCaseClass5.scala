...
trait DebugCaseClass5Instance {
  implicit def zsgTupleToDebugCaseClass5InstanceImplicit[D1, D2, D3, D4, D5]: ZsgTupleToDebugCaseClass[
    ...
    new ZsgTupleToDebugCaseClass[
      ...
      override def tupleToCaseClass(tuple: zsg.ZTuple5[D1, D2, D3, D4, D5]): DebugCaseClass5[D1, D2, D3, D4, D5] = {
...
case class DebugCaseClass5[D1, D2, D3, D4, D5](d1: D1, d2: D2, d3: D3, d4: D4, d5: D5) {
  def infer(implicit d1: D1, d2: D2, d3: D3, d4: D4, d5: D5): DebugCaseClass5[D1, D2, D3, D4, D5] = {
