...
trait DebugCaseClass3Instance {
  implicit def zsgTupleToDebugCaseClass3InstanceImplicit[D1, D2, D3]: ZsgTupleToDebugCaseClass[
    ...
    new ZsgTupleToDebugCaseClass[
      ...
      override def tupleToCaseClass(tuple: zsg.ZTuple3[D1, D2, D3]): DebugCaseClass3[D1, D2, D3] = {
        DebugCaseClass3(d1 = tuple.i1, d2 = tuple.i2, d3 = tuple.i3)
      }
    }
}
case class DebugCaseClass3[D1, D2, D3](d1: D1, d2: D2, d3: D3) {
  def infer(implicit d1: D1, d2: D2, d3: D3): DebugCaseClass3[D1, D2, D3] = {
