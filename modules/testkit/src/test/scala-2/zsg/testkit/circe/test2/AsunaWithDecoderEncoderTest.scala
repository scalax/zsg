...
class AsunaWithDecoderEncoderTest extends AnyFunSpec with Matchers {
  ...
  describe("zsg encoder") {
    ...
    it("generic the same sealed trait json object as circe") {
      ...
      Asuna.i6FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test06[_]] shouldBe true
      Asuna.i7FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test07[_]] shouldBe true
      Asuna.i8FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test08] shouldBe true
      Asuna.i9FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test09.type] shouldBe true

      Asuna.i6FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test05[_]] shouldBe true
      Asuna.i7FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test05[_]] shouldBe true
      Asuna.i8FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test05[_]] shouldBe true
      Asuna.i9FromJson.right.getOrElse((throw new Exception()): Test05[String]).isInstanceOf[Test05[_]] shouldBe true
    }
  }
