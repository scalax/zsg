...
object i extends Context2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I] {
...
object reverseI extends Context2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I] {
...
object in {
  ...
  def encoder[I1, I2 <: TupleTag, X, Y](
    ...
    pp: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, I2, X, Y],
  ...
  class ToStringApply2[I2 <: TupleTag] {
    def init2[I3, I4](implicit app1: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, I2, I3, I4]): ToStringApply3[I2, I3, I4] =
      new ToStringApply3[I2, I3, I4] {
        override def app: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, I2, I3, I4] = app1
      }
  }

  trait ToStringApply3[I2 <: TupleTag, I3, I4] {
    def app: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, I2, I3, I4]
  ...
  implicit val pp1: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[String], String, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[String], String, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I]): (String, String) => ModelToString = (t, r) => {
        new ModelToString {
  ...
  implicit val pp2: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[Int], Int, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[Int], Int, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I]): (Int, String) => ModelToString = (t, r) => {
        new ModelToString {
  ...
  implicit val pp3: Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[Long], Long, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I, PropertyTag[Long], Long, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ModelToString })#I]): (Long, String) => ModelToString = (t, r) => {
        new ModelToString {
