...
object i extends Context2[({ type I[I1, I2] = (I1, I2) => ListToString })#I] {

  override def append[X1, X2, Y1, Y2, Z1, Z2](x: (X1, X2) => ListToString, y: (Y1, Y2) => ListToString)(p: Plus2[X1, X2, Y1, Y2, Z1, Z2]): (Z1, Z2) => ListToString = {
    (i1, i2) =>
  ...
  override def start: (AsunaTuple0, AsunaTuple0) => ListToString = { (i1: AsunaTuple0, i2: AsunaTuple0) =>
    new ListToString {
...
object in {
  ...
  def encoder[I1, I2 <: TupleTag, I3, I4](
    ...
    pp: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, I2, I3, I4],
  ...
  class ToStringApply2[I2 <: TupleTag] {
    def init2[I3, I4](implicit app1: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, I2, I3, I4]): ToStringApply3[I2, I3, I4] =
      new ToStringApply3[I2, I3, I4] {
        override def app: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, I2, I3, I4] = app1
      }
  }

  trait ToStringApply3[I2 <: TupleTag, I3, I4] {
    def app: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, I2, I3, I4]
  ...
  implicit val pp1: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[String], String, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[String], String, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ListToString })#I]): (String, String) => ListToString = (t, r) => {
        new ListToString {
  ...
  implicit val pp2: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[Int], Int, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[Int], Int, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ListToString })#I]): (Int, String) => ListToString = (t, r) => {
        new ListToString {
  ...
  implicit val pp3: Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[Long], Long, String] =
    new Application2[({ type I[I1, I2] = (I1, I2) => ListToString })#I, PropertyTag[Long], Long, String] {
      override def application(context: Context2[({ type I[I1, I2] = (I1, I2) => ListToString })#I]): (Long, String) => ListToString = (t, r) => {
        new ListToString {
