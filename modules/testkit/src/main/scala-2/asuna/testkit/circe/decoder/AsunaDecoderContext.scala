...
object AsunaDecoderContext extends Context3[JsonDecoderPro] {
  ...
  ): JsonDecoderPro[Z1, Z2, Z3] = new JsonDecoderPro[Z1, Z2, Z3] {
    override def to(name: Z2, default: Z3): Decoder[Z1] = {
  ...
  override def start: JsonDecoderPro[AsunaTuple0, AsunaTuple0, AsunaTuple0] = new JsonDecoderPro[AsunaTuple0, AsunaTuple0, AsunaTuple0] {
