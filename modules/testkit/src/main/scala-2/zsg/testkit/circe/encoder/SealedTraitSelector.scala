...
object SealedTraitSelector {
  ...
  ): Application[SealedTraitSelector[P], ZsgSealedContext[P], SealedTag[S], TypeAlias.TypeHList2[Class[S], String]] =
    new Application[SealedTraitSelector[P], ZsgSealedContext[P], SealedTag[S], TypeAlias.TypeHList2[Class[S], String]] {
