...
import io.circe._
import zsg.{Application, PropertyTag, TypeAlias, TypeFunction, TypeHList}
...
object JsonDecoderFunc {
  ...
  ): Application[JsonDecoderFunc, ZsgDecoderContext, PropertyTag[T1], TypeAlias.TypeHList3[T1, String, DefaultValue[T1]]] =
    new Application[JsonDecoderFunc, ZsgDecoderContext, PropertyTag[T1], TypeAlias.TypeHList3[T1, String, DefaultValue[T1]]] {
