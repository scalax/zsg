...
import zsg.{Application, TypeAlias, TypeFunction, TypeHList}
...
object SealedTraitSelector {
  ...
  ): Application[SealedTraitSelector[P], ZsgSealedContext[P], SealedTag[S], TypeAlias.TypeHList2[SealedTag[S], String]] =
    new Application[SealedTraitSelector[P], ZsgSealedContext[P], SealedTag[S], TypeAlias.TypeHList2[SealedTag[S], String]] {
      override def application(context: ZsgSealedContext[P]): SealedTraitSelector[P]#H[TypeAlias.TypeHList2[SealedTag[S], String]] =
