...
object ApplicationX12 {
  implicit def applicationImplicit[F[_, _, _, _, _, _, _, _, _, _, _, _], T <: Context12[F], I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12](implicit
  ...
  ): ApplicationX12[F, T, zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[I4, Y4], zsg.ZsgTuple2[I5, Y5], zsg.ZsgTuple2[
    I6,
    Y6
  ], zsg.ZsgTuple2[I7, Y7], zsg.ZsgTuple2[I8, Y8], zsg.ZsgTuple2[I9, Y9], zsg.ZsgTuple2[I10, Y10], zsg.ZsgTuple2[I11, Y11], zsg.ZsgTuple2[I12, Y12]] =
    new ApplicationX12[
      F,
      T,
      zsg.ZsgTuple2[I1, Y1],
