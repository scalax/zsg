...
object ApplicationX19 {
  ...
  implicit def applicationImplicit2[F[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], T <: Context19[
  ...
  ): ApplicationX19[F, T, zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[I4, Y4], zsg.ZsgTuple2[I5, Y5], zsg.ZsgTuple2[
    I6,
    Y6
    ...
    I13,
    Y13
  ], zsg.ZsgTuple2[I14, Y14], zsg.ZsgTuple2[I15, Y15], zsg.ZsgTuple2[I16, Y16], zsg.ZsgTuple2[I17, Y17], zsg.ZsgTuple2[I18, Y18], zsg.ZsgTuple2[I19, Y19]] =
    new ApplicationX19[
      F,
      T,
      zsg.ZsgTuple2[I1, Y1],
