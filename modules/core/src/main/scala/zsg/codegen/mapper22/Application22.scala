package zsg
abstract class Application22[F[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], T <: Context22[
  F
...
object Application22 {
  ...
  ): Application22[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12, I13, I14, I15, I16, I17, I18, I19, I20, I21, I22] =
    new Application22[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12, I13, I14, I15, I16, I17, I18, I19, I20, I21, I22] {
      def application(context: T): F[I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12, I13, I14, I15, I16, I17, I18, I19, I20, I21, I22] =
        i
    }
  implicit def applicationImplicit2[F[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], T <: Context22[
    ...
    implicit
    i1: Application22[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12, I13, I14, I15, I16, I17, I18, I19, I20, I21, I22],
    i2: Application22[F, T, Y1, Y2, Y3, Y4, Y5, Y6, Y7, Y8, Y9, Y10, Y11, Y12, Y13, Y14, Y15, Y16, Y17, Y18, Y19, Y20, Y21, Y22]
  ): Application22[F, T, zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[I4, Y4], zsg.ZsgTuple2[
    I5,
    Y5
    ...
    I16,
    Y16
  ], zsg.ZsgTuple2[I17, Y17], zsg.ZsgTuple2[I18, Y18], zsg.ZsgTuple2[I19, Y19], zsg.ZsgTuple2[I20, Y20], zsg.ZsgTuple2[
    I21,
    Y21
    ...
    new Application22[
      ...
      def application(context: T): F[zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[
        ...
        I15,
        Y15
      ], zsg.ZsgTuple2[I16, Y16], zsg.ZsgTuple2[I17, Y17], zsg.ZsgTuple2[I18, Y18], zsg.ZsgTuple2[I19, Y19], zsg.ZsgTuple2[
        I20,
        Y20
