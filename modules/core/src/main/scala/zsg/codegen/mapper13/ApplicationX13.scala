package zsg
abstract class ApplicationX13[F[_, _, _, _, _, _, _, _, _, _, _, _, _], T <: Context13[
  F
...
object ApplicationX13 {
  ...
  ): ApplicationX13[F, T, zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[I4, Y4], zsg.ZsgTuple2[
    I5,
    Y5
  ], zsg.ZsgTuple2[
    I6,
