package zsg
abstract class Application10[F[_, _, _, _, _, _, _, _, _, _], T <: Context10[F], I1, I2, I3, I4, I5, I6, I7, I8, I9, I10] {
  def application(context: T): F[I1, I2, I3, I4, I5, I6, I7, I8, I9, I10]
}
object Application10 {
  ...
  ): Application10[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10] =
    new Application10[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10] {
  ...
  implicit def applicationImplicit2[F[_, _, _, _, _, _, _, _, _, _], T <: Context10[
    ...
    i1: Application10[F, T, I1, I2, I3, I4, I5, I6, I7, I8, I9, I10],
    i2: Application10[F, T, Y1, Y2, Y3, Y4, Y5, Y6, Y7, Y8, Y9, Y10]
  ): Application10[F, T, zsg.ZsgTuple2[I1, Y1], zsg.ZsgTuple2[I2, Y2], zsg.ZsgTuple2[I3, Y3], zsg.ZsgTuple2[I4, Y4], zsg.ZsgTuple2[
    I5,
    Y5
