...
trait SOFAlias6 {
  type ZTuple6[T1, T2, T3, T4, T5, T6]                   = P_3_Step_1[T1, T2, S_2[T3, T4, T5], S_0[T6]]
  type ZTuple7[T1, T2, T3, T4, T5, T6, T7]               = P_3_Step_1[T1, T2, S_2[T3, T4, T5], S_1[T6, T7]]
