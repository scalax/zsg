...
trait NodeTag2ApplicationCompanion {
  ...
  final implicit def noteTagApplicationImplicit_tagNum2_typeParamNum2[
    ...
    new Application2[F, NodeTag2[H1, H2], AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2]] {
      override final def application(context: Context2[F]): F[AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2]] = {
  ...
  final implicit def noteTagApplicationImplicit_tagNum2_typeParamNum3[
    ...
    new Application3[F, NodeTag2[H1, H2], AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2], AsunaTuple2[X1_C3, X2_C3]] {
      override final def application(context: Context3[F]): F[AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2], AsunaTuple2[X1_C3, X2_C3]] = {
