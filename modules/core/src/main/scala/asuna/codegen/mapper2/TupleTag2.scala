...
final object TupleTag2 {
  ...
  ): Application1[F, TupleTag2[H1, H2], AsunaTuple2[X1_C1, X2_C1]] = { context: Context1[F] =>
  ...
  ): Application2[F, TupleTag2[H1, H2], AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2]] = { context: Context2[F] =>
  ...
  ): Application3[F, TupleTag2[H1, H2], AsunaTuple2[X1_C1, X2_C1], AsunaTuple2[X1_C2, X2_C2], AsunaTuple2[X1_C3, X2_C3]] = { context: Context3[F] =>
