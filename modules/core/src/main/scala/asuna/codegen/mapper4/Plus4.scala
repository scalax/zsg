...
object Plus4 {
    final def cachePlusWithTypeParameter0Dynamic[Y1 , Y2 , Y3 , Y4]: Plus4[
        Y1 , Y2 , Y3 , Y4,
    ...
    final val cachePlusWithTypeParameter0Strict: Plus4[
        Any , Any , Any , Any,
        AsunaTuple0 , AsunaTuple0 , AsunaTuple0 , AsunaTuple0,
        AsunaTuple1[Any] , AsunaTuple1[Any] , AsunaTuple1[Any] , AsunaTuple1[Any]
    ] = cachePlusWithTypeParameter0Dynamic[Any , Any , Any , Any]
    final def cachePlusWithTypeParameter0[Y1 , Y2 , Y3 , Y4]: Plus4[
        Y1 , Y2 , Y3 , Y4,
        AsunaTuple0 , AsunaTuple0 , AsunaTuple0 , AsunaTuple0,
        AsunaTuple1[Y1] , AsunaTuple1[Y2] , AsunaTuple1[Y3] , AsunaTuple1[Y4]
    ] = cachePlusWithTypeParameter0Strict.asInstanceOf[Plus4[
        Y1 , Y2 , Y3 , Y4,
        AsunaTuple0 , AsunaTuple0 , AsunaTuple0 , AsunaTuple0,
        AsunaTuple1[Y1] , AsunaTuple1[Y2] , AsunaTuple1[Y3] , AsunaTuple1[Y4]
    ]]
    ...
    final val cachePlusWithTypeParameter1Strict: Plus4[
        Any , Any , Any , Any,
        Any , Any , Any , Any,
    ...
    final def cachePlusWithTypeParameter1[
        ...
        Y1 , Y2 , Y3 , Y4,
        AsunaTuple2[Y1, X1] , AsunaTuple2[Y2, X2] , AsunaTuple2[Y3, X3] , AsunaTuple2[Y4, X4]
    ] = cachePlusWithTypeParameter1Strict.asInstanceOf[Plus4[
        X1 , X2 , X3 , X4,
        Y1 , Y2 , Y3 , Y4,
        AsunaTuple2[Y1, X1] , AsunaTuple2[Y2, X2] , AsunaTuple2[Y3, X3] , AsunaTuple2[Y4, X4]
    ]]
