...
final object TupleTag4 {
  ...
  ): Application1[F, TupleTag4[H1, H2, H3, H4], AsunaTuple4[X1_C1, X2_C1, X3_C1, X4_C1]] = { context: Context1[F] =>
    context.append(
      context.append(
  ...
  ): Application2[F, TupleTag4[H1, H2, H3, H4], AsunaTuple4[X1_C1, X2_C1, X3_C1, X4_C1], AsunaTuple4[X1_C2, X2_C2, X3_C2, X4_C2]] = { context: Context2[F] =>
    context.append(
      context.append(
