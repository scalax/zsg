...
final object NodeTag1 {
  ...
  ): Application1[F, NodeTag1[H1], AsunaTuple1[X1_C1]] = { context: Context1[F] =>
  ...
  ): Application2[F, NodeTag1[H1], AsunaTuple1[X1_C1], AsunaTuple1[X1_C2]] = { context: Context2[F] =>
  ...
  ): Application3[F, NodeTag1[H1], AsunaTuple1[X1_C1], AsunaTuple1[X1_C2], AsunaTuple1[X1_C3]] = { context: Context3[F] =>
  ...
  ): Application4[F, NodeTag1[H1], AsunaTuple1[X1_C1], AsunaTuple1[X1_C2], AsunaTuple1[X1_C3], AsunaTuple1[X1_C4]] = { context: Context4[F] =>
  ...
  ): Application5[F, NodeTag1[H1], AsunaTuple1[X1_C1], AsunaTuple1[X1_C2], AsunaTuple1[X1_C3], AsunaTuple1[X1_C4], AsunaTuple1[X1_C5]] = { context: Context5[F] =>
