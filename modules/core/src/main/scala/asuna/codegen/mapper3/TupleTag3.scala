...
final object TupleTag3 {
  ...
  ): Application1[F, TupleTag3[H1, H2, H3], AsunaTuple3[X1_C1, X2_C1, X3_C1]] = { context: Context1[F] =>
    context.append(
  ...
  ): Application2[F, TupleTag3[H1, H2, H3], AsunaTuple3[X1_C1, X2_C1, X3_C1], AsunaTuple3[X1_C2, X2_C2, X3_C2]] = { context: Context2[F] =>
    context.append(
