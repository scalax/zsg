...
class AsunaTuple6[E1, E2, E3, E4, E5, E6](override val head: E1, override val tail: AsunaTuple5[E2, E3, E4, E5, E6]) extends HList {
  override type Head = E1
  override type Tail = AsunaTuple5[E2, E3, E4, E5, E6]
  def i1: E1 = head
  def i2: E2 = tail.head
