...
class TypeHListPlus6 {
  @inline final def plus6[E1 <: TypeHList, E2 <: TypeHList, E3 <: TypeHList, E4 <: TypeHList, E5 <: TypeHList, E6 <: TypeHList]: Plus[
...
final object TypeHListPlus6 extends TypeHListPlus6
