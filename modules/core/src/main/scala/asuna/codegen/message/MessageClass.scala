...
implicit def tupleDebugApplication1Implicit[ProName, Index, F[_ ], Tag  , X1 ](implicit app: asuna.Application1[F, Tag  , X1 ]): TupleDebugApplication1[ProName, Index, F, Tag  , X1 ] = {
...
implicit def nodeDebugApplication2Implicit[Message, F[_  , _ ], Tag  , X1  , X2 ](implicit app: asuna.Application2[F, Tag  , X1  , X2 ]): NodeDebugApplication2[Message, F, Tag  , X1  , X2 ] = {
...
implicit def tupleDebugApplication2Implicit[ProName, Index, F[_  , _ ], Tag  , X1  , X2 ](implicit app: asuna.Application2[F, Tag  , X1  , X2 ]): TupleDebugApplication2[ProName, Index, F, Tag  , X1  , X2 ] = {
...
implicit def nodeDebugApplication3Implicit[Message, F[_  , _  , _ ], Tag  , X1  , X2  , X3 ](implicit app: asuna.Application3[F, Tag  , X1  , X2  , X3 ]): NodeDebugApplication3[Message, F, Tag  , X1  , X2  , X3 ] = {
...
implicit def tupleDebugApplication3Implicit[ProName, Index, F[_  , _  , _ ], Tag  , X1  , X2  , X3 ](implicit app: asuna.Application3[F, Tag  , X1  , X2  , X3 ]): TupleDebugApplication3[ProName, Index, F, Tag  , X1  , X2  , X3 ] = {
...
implicit def nodeDebugApplication4Implicit[Message, F[_  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4 ](implicit app: asuna.Application4[F, Tag  , X1  , X2  , X3  , X4 ]): NodeDebugApplication4[Message, F, Tag  , X1  , X2  , X3  , X4 ] = {
...
implicit def tupleDebugApplication4Implicit[ProName, Index, F[_  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4 ](implicit app: asuna.Application4[F, Tag  , X1  , X2  , X3  , X4 ]): TupleDebugApplication4[ProName, Index, F, Tag  , X1  , X2  , X3  , X4 ] = {
...
implicit def nodeDebugApplication5Implicit[Message, F[_  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5 ](implicit app: asuna.Application5[F, Tag  , X1  , X2  , X3  , X4  , X5 ]): NodeDebugApplication5[Message, F, Tag  , X1  , X2  , X3  , X4  , X5 ] = {
...
implicit def tupleDebugApplication5Implicit[ProName, Index, F[_  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5 ](implicit app: asuna.Application5[F, Tag  , X1  , X2  , X3  , X4  , X5 ]): TupleDebugApplication5[ProName, Index, F, Tag  , X1  , X2  , X3  , X4  , X5 ] = {
...
implicit def nodeDebugApplication6Implicit[Message, F[_  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6 ](implicit app: asuna.Application6[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6 ]): NodeDebugApplication6[Message, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6 ] = {
...
implicit def tupleDebugApplication6Implicit[ProName, Index, F[_  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6 ](implicit app: asuna.Application6[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6 ]): TupleDebugApplication6[ProName, Index, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6 ] = {
...
implicit def nodeDebugApplication7Implicit[Message, F[_  , _  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ](implicit app: asuna.Application7[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ]): NodeDebugApplication7[Message, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ] = {
...
implicit def tupleDebugApplication7Implicit[ProName, Index, F[_  , _  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ](implicit app: asuna.Application7[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ]): TupleDebugApplication7[ProName, Index, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7 ] = {
...
implicit def nodeDebugApplication8Implicit[Message, F[_  , _  , _  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ](implicit app: asuna.Application8[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ]): NodeDebugApplication8[Message, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ] = {
...
@implicitNotFound(msg = "ProName: ${ProName}\nindex: ${Index}")
trait TupleDebugApplication8[ProName, Index, F[_  , _  , _  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ] extends asuna.Application8[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ] {
override def application(context: asuna.Context8[F]): F[X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ]
}
object TupleDebugApplication8 {
implicit def tupleDebugApplication8Implicit[ProName, Index, F[_  , _  , _  , _  , _  , _  , _  , _ ], Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ](implicit app: asuna.Application8[F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ]): TupleDebugApplication8[ProName, Index, F, Tag  , X1  , X2  , X3  , X4  , X5  , X6  , X7  , X8 ] = {
