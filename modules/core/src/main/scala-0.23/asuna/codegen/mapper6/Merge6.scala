...
object Merge6 {
        ...
        )  as  Merge6[NodeTag1[X1_C1] , NodeTag1[X2_C1] , NodeTag1[X3_C1] , NodeTag1[X4_C1] , NodeTag1[X5_C1] , NodeTag1[X6_C1] , NodeTag1[Target1]] = {
        ...
        )  as  Merge6[TupleTag1[X1_C1] , TupleTag1[X2_C1] , TupleTag1[X3_C1] , TupleTag1[X4_C1] , TupleTag1[X5_C1] , TupleTag1[X6_C1] , TupleTag1[Target1]] = {
        ...
        )  as  Merge6[NodeTag2[X1_C1 , X1_C2] , NodeTag2[X2_C1 , X2_C2] , NodeTag2[X3_C1 , X3_C2] , NodeTag2[X4_C1 , X4_C2] , NodeTag2[X5_C1 , X5_C2] , NodeTag2[X6_C1 , X6_C2] , NodeTag2[Target1 , Target2]] = {
        ...
        )  as  Merge6[TupleTag2[X1_C1 , X1_C2] , TupleTag2[X2_C1 , X2_C2] , TupleTag2[X3_C1 , X3_C2] , TupleTag2[X4_C1 , X4_C2] , TupleTag2[X5_C1 , X5_C2] , TupleTag2[X6_C1 , X6_C2] , TupleTag2[Target1 , Target2]] = {
    ...
    ]  as  Merge6[PropertyTag1[X1, Data] , PropertyTag1[X2, Data] , PropertyTag1[X3, Data] , PropertyTag1[X4, Data] , PropertyTag1[X5, Data] , PropertyTag1[X6, Data] , PropertyTag6[X1 , X2 , X3 , X4 , X5 , X6, Data]] = {
        ...
        X1 , X2 , X3 , X4 , X5 , X6, Data
    ]  as  Merge6[EntiretyTag1[X1, Data] , EntiretyTag1[X2, Data] , EntiretyTag1[X3, Data] , EntiretyTag1[X4, Data] , EntiretyTag1[X5, Data] , EntiretyTag1[X6, Data] , EntiretyTag6[X1 , X2 , X3 , X4 , X5 , X6, Data]] = {
