...
object Merge7 {
        ...
        )  as  Merge7[NodeTag1[X1_C1] , NodeTag1[X2_C1] , NodeTag1[X3_C1] , NodeTag1[X4_C1] , NodeTag1[X5_C1] , NodeTag1[X6_C1] , NodeTag1[X7_C1] , NodeTag1[Target1]] = {
        ...
        inline given  tupletag1_merge7_implicit[
            X1_C1 , X2_C1 , X3_C1 , X4_C1 , X5_C1 , X6_C1 , X7_C1,
            Target1
        ]( using 
            tupleTagImplicit1: Merge7[X1_C1 , X2_C1 , X3_C1 , X4_C1 , X5_C1 , X6_C1 , X7_C1 , Target1]
        )  as  Merge7[TupleTag1[X1_C1] , TupleTag1[X2_C1] , TupleTag1[X3_C1] , TupleTag1[X4_C1] , TupleTag1[X5_C1] , TupleTag1[X6_C1] , TupleTag1[X7_C1] , TupleTag1[Target1]] = {
        ...
        )  as  Merge7[NodeTag2[X1_C1 , X1_C2] , NodeTag2[X2_C1 , X2_C2] , NodeTag2[X3_C1 , X3_C2] , NodeTag2[X4_C1 , X4_C2] , NodeTag2[X5_C1 , X5_C2] , NodeTag2[X6_C1 , X6_C2] , NodeTag2[X7_C1 , X7_C2] , NodeTag2[Target1 , Target2]] = {
        ...
        inline given  tupletag2_merge7_implicit[
        ...
        )  as  Merge7[TupleTag2[X1_C1 , X1_C2] , TupleTag2[X2_C1 , X2_C2] , TupleTag2[X3_C1 , X3_C2] , TupleTag2[X4_C1 , X4_C2] , TupleTag2[X5_C1 , X5_C2] , TupleTag2[X6_C1 , X6_C2] , TupleTag2[X7_C1 , X7_C2] , TupleTag2[Target1 , Target2]] = {
        ...
        inline given  property_tag_merge7_implicit[
        X1 , X2 , X3 , X4 , X5 , X6 , X7, Data
    ]  as  Merge7[PropertyTag1[X1, Data] , PropertyTag1[X2, Data] , PropertyTag1[X3, Data] , PropertyTag1[X4, Data] , PropertyTag1[X5, Data] , PropertyTag1[X6, Data] , PropertyTag1[X7, Data] , PropertyTag7[X1 , X2 , X3 , X4 , X5 , X6 , X7, Data]] = {
        ...
        inline given  entirety_tag_merge7_implicit[
        X1 , X2 , X3 , X4 , X5 , X6 , X7, Data
    ]  as  Merge7[EntiretyTag1[X1, Data] , EntiretyTag1[X2, Data] , EntiretyTag1[X3, Data] , EntiretyTag1[X4, Data] , EntiretyTag1[X5, Data] , EntiretyTag1[X6, Data] , EntiretyTag1[X7, Data] , EntiretyTag7[X1 , X2 , X3 , X4 , X5 , X6 , X7, Data]] = {
        new Merge7[EntiretyTag1[X1, Data] , EntiretyTag1[X2, Data] , EntiretyTag1[X3, Data] , EntiretyTag1[X4, Data] , EntiretyTag1[X5, Data] , EntiretyTag1[X6, Data] , EntiretyTag1[X7, Data] , EntiretyTag7[X1 , X2 , X3 , X4 , X5 , X6 , X7, Data]]
    }
}
