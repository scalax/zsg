...
class ZTuple10[I1, I2, I3, I4, I5, I6, I7, I8, I9, I10](
  val i1: I1,
  val i2: I2,
  val i3: I3,
  val i4: I4,
...
object ZTuple10 {
  implicit def contextNum1[F[_], T <: Context1[
    ...
    Tuple9_Context1,
    Tuple10_Context1
  ]] = new ApplicationX1[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum1)
    }
  }
  implicit def contextNum2[F[_, _], T <: Context2[
    ...
    Tuple9_Context2,
    Tuple10_Context2
  ]] = new ApplicationX2[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum2)
    }
  }
  implicit def contextNum3[F[_, _, _], T <: Context3[
    ...
    Tuple9_Context3,
    Tuple10_Context3
  ]] = new ApplicationX3[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum3)
    }
  }
  implicit def contextNum4[F[_, _, _, _], T <: Context4[
    ...
    Tuple9_Context4,
    Tuple10_Context4
  ]] = new ApplicationX4[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum4)
    }
  }
  implicit def contextNum5[F[_, _, _, _, _], T <: Context5[
    ...
    Tuple9_Context5,
    Tuple10_Context5
  ]] = new ApplicationX5[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum5)
    }
  }
  implicit def contextNum6[F[_, _, _, _, _, _], T <: Context6[
    ...
    Tuple9_Context6,
    Tuple10_Context6
  ]] = new ApplicationX6[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum6)
    }
  }
  implicit def contextNum7[F[_, _, _, _, _, _, _], T <: Context7[
    ...
    Tuple9_Context7,
    Tuple10_Context7
  ]] = new ApplicationX7[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum7)
    }
  }
  implicit def contextNum8[F[_, _, _, _, _, _, _, _], T <: Context8[
    ...
    Tuple9_Context8,
    Tuple10_Context8
  ]] = new ApplicationX8[F, T, ZTuple10[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t10
      )(PlusInstanceTuple10.contextNum8)
    }
  }
}
