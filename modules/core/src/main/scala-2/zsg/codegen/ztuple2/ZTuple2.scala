...
object ZTuple2 {
  ...
  ): ApplicationX1[F, T, ZTuple2[Tuple1_Context1, Tuple2_Context1]] =
    new ApplicationX1[F, T, ZTuple2[Tuple1_Context1, Tuple2_Context1]] {
  ...
  implicit def contextNum6[F[_, _, _, _, _, _], T <: Context6[
    ...
    Tuple1_Context4,
    Tuple2_Context4
  ], ZTuple2[Tuple1_Context5, Tuple2_Context5], ZTuple2[Tuple1_Context6, Tuple2_Context6]] =
    new ApplicationX6[
      F,
      T,
      ZTuple2[Tuple1_Context1, Tuple2_Context1],
  ...
  implicit def contextNum7[F[_, _, _, _, _, _, _], T <: Context7[
    ...
    Tuple1_Context4,
    Tuple2_Context4
  ], ZTuple2[Tuple1_Context5, Tuple2_Context5], ZTuple2[Tuple1_Context6, Tuple2_Context6], ZTuple2[Tuple1_Context7, Tuple2_Context7]] =
    new ApplicationX7[
      F,
      T,
      ZTuple2[Tuple1_Context1, Tuple2_Context1],
