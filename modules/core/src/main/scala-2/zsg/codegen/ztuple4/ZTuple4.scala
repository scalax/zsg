  ...
  implicit def contextNum1[F[_], T <: Context1[F], Tuple1_Context1, Tuple2_Context1, Tuple3_Context1, Tuple4_Context1](implicit
    ...
    new ApplicationX1[F, T, ZTuple4[Tuple1_Context1, Tuple2_Context1, Tuple3_Context1, Tuple4_Context1]] {
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum1), t3)(PlusInstanceZsgTuple2.contextNum1), t4)(PlusInstanceTuple4.contextNum1)
      }
    }
  implicit def contextNum2[F[_, _], T <: Context2[
    ...
    new ApplicationX2[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum2), t3)(PlusInstanceZsgTuple2.contextNum2), t4)(PlusInstanceTuple4.contextNum2)
      }
    }
  implicit def contextNum3[F[_, _, _], T <: Context3[
    ...
    new ApplicationX3[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum3), t3)(PlusInstanceZsgTuple2.contextNum3), t4)(PlusInstanceTuple4.contextNum3)
      }
    }
  implicit def contextNum4[F[_, _, _, _], T <: Context4[
    ...
    new ApplicationX4[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum4), t3)(PlusInstanceZsgTuple2.contextNum4), t4)(PlusInstanceTuple4.contextNum4)
      }
    }
  implicit def contextNum5[F[_, _, _, _, _], T <: Context5[
    ...
    new ApplicationX5[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum5), t3)(PlusInstanceZsgTuple2.contextNum5), t4)(PlusInstanceTuple4.contextNum5)
      }
    }
  implicit def contextNum6[F[_, _, _, _, _, _], T <: Context6[
    ...
    new ApplicationX6[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum6), t3)(PlusInstanceZsgTuple2.contextNum6), t4)(PlusInstanceTuple4.contextNum6)
      }
    }
  implicit def contextNum7[F[_, _, _, _, _, _, _], T <: Context7[
    ...
    new ApplicationX7[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum7), t3)(PlusInstanceZsgTuple2.contextNum7), t4)(PlusInstanceTuple4.contextNum7)
      }
    }
  implicit def contextNum8[F[_, _, _, _, _, _, _, _], T <: Context8[
    ...
    new ApplicationX8[
      ...
      override def application(context: T): F[
        ...
        context
          .append(context.append(context.append(t1, t2)(PlusInstanceZsgTuple2.contextNum8), t3)(PlusInstanceZsgTuple2.contextNum8), t4)(PlusInstanceTuple4.contextNum8)
      }
    }
}
