...
class ZTuple13[I1, I2, I3, I4, I5, I6, I7, I8, I9, I10, I11, I12, I13](
  val i1: I1,
  val i2: I2,
  val i3: I3,
  val i4: I4,
...
object ZTuple13 {
  implicit def contextNum1[F[_], T <: Context1[
    ...
    Tuple12_Context1,
    Tuple13_Context1
  ]] = new ApplicationX1[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum1)
    }
  }
  implicit def contextNum2[F[_, _], T <: Context2[
    ...
    Tuple12_Context2,
    Tuple13_Context2
  ]] = new ApplicationX2[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum2)
    }
  }
  implicit def contextNum3[F[_, _, _], T <: Context3[
    ...
    Tuple12_Context3,
    Tuple13_Context3
  ]] = new ApplicationX3[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum3)
    }
  }
  implicit def contextNum4[F[_, _, _, _], T <: Context4[
    ...
    Tuple12_Context4,
    Tuple13_Context4
  ]] = new ApplicationX4[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum4)
    }
  }
  implicit def contextNum5[F[_, _, _, _, _], T <: Context5[
    ...
    Tuple12_Context5,
    Tuple13_Context5
  ]] = new ApplicationX5[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum5)
    }
  }
  implicit def contextNum6[F[_, _, _, _, _, _], T <: Context6[
    ...
    Tuple12_Context6,
    Tuple13_Context6
  ]] = new ApplicationX6[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum6)
    }
  }
  implicit def contextNum7[F[_, _, _, _, _, _, _], T <: Context7[
    ...
    Tuple12_Context7,
    Tuple13_Context7
  ]] = new ApplicationX7[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum7)
    }
  }
  implicit def contextNum8[F[_, _, _, _, _, _, _, _], T <: Context8[
    ...
    Tuple12_Context8,
    Tuple13_Context8
  ]] = new ApplicationX8[F, T, ZTuple13[
    Tuple1_Context1,
    Tuple2_Context1,
    Tuple3_Context1,
    Tuple4_Context1,
    ...
    override def application(context: T): F[
      ...
      context.append(
        ...
        t13
      )(PlusInstanceTuple13.contextNum8)
    }
  }
}
