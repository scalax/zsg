...
object Merge3 {
        ...
        )  as  Merge3[NodeTag1[X1_C1] , NodeTag1[X2_C1] , NodeTag1[X3_C1] , NodeTag1[Target1]] = {
        ...
        )  as  Merge3[TupleTag1[X1_C1] , TupleTag1[X2_C1] , TupleTag1[X3_C1] , TupleTag1[Target1]] = {
        ...
        )  as  Merge3[NodeTag2[X1_C1 , X1_C2] , NodeTag2[X2_C1 , X2_C2] , NodeTag2[X3_C1 , X3_C2] , NodeTag2[Target1 , Target2]] = {
        ...
        )  as  Merge3[TupleTag2[X1_C1 , X1_C2] , TupleTag2[X2_C1 , X2_C2] , TupleTag2[X3_C1 , X3_C2] , TupleTag2[Target1 , Target2]] = {
        ...
        X1 , X2 , X3, Data
    ]  as  Merge3[PropertyTag1[X1, Data] , PropertyTag1[X2, Data] , PropertyTag1[X3, Data] , PropertyTag3[X1 , X2 , X3, Data]] = {
        ...
        X1 , X2 , X3, Data
    ]  as  Merge3[EntiretyTag1[X1, Data] , EntiretyTag1[X2, Data] , EntiretyTag1[X3, Data] , EntiretyTag3[X1 , X2 , X3, Data]] = {
