...
object Plus1 {
  ...
  final def cachePlusWithTypeParameter1[X1_C1, Y1]: Plus1[
    ...
    new Plus1[
      ...
      final override def plus1(x: AsunaTuple1[X1_C1], y: Y1): AsunaTuple2[Y1, X1_C1] = x.::(y)                                                                                                                                                                                                                                                                                   l..
      ...
      000000000231111111111111111111111111111111111111111111111111111111111111111111111111111111111
    }
