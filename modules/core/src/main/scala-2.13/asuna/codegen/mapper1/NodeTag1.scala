...
final class NodeTag1[T1 <: TupleTag] extends TupleTag {
  ...
  def debug[F[_], X1_C1](c: Context1[F])(
    implicit
  ...
  def debug[F[_, _], X1_C1, X1_C2](c: Context2[F])(
    implicit
  ...
  def debug[F[_, _, _, _], X1_C1, X1_C2, X1_C3, X1_C4](c: Context4[F])(
    implicit
  ...
  def debug[F[_, _, _, _, _], X1_C1, X1_C2, X1_C3, X1_C4, X1_C5](c: Context5[F])(
    implicit
  ...
  def debug[F[_, _, _, _, _, _], X1_C1, X1_C2, X1_C3, X1_C4, X1_C5, X1_C6](c: Context6[F])(
    implicit
  ...
  def debug[F[_, _, _, _, _, _, _], X1_C1, X1_C2, X1_C3, X1_C4, X1_C5, X1_C6, X1_C7](c: Context7[F])(
    implicit
  ...
  def debug[F[_, _, _, _, _, _, _, _], X1_C1, X1_C2, X1_C3, X1_C4, X1_C5, X1_C6, X1_C7, X1_C8](c: Context8[F])(
    implicit
