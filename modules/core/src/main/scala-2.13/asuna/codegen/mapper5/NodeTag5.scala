...
final class NodeTag5[T1 <: TupleTag, T2 <: TupleTag, T3 <: TupleTag, T4 <: TupleTag, T5 <: TupleTag] extends TupleTag {
  ...
  def debug[F[_, _, _, _, _, _, _], X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X1_C2, X2_C2, X3_C2, X4_C2, X5_C2, X1_C3, X2_C3, X3_C3, X4_C3, X5_C3, X1_C4, X2_C4, X3_C4, X4_C4, X5_C4, X1_C5, X2_C5, X3_C5, X4_C5, X5_C5, X1_C6, X2_C6, X3_C6, X4_C6, X5_C6, X1_C7, X2_C7, X3_C7, X4_C7, X5_C7](
    c: Context7[F]
  )(
    implicit
  ...
  def debug[F[_, _, _, _, _, _, _, _], X1_C1, X2_C1, X3_C1, X4_C1, X5_C1, X1_C2, X2_C2, X3_C2, X4_C2, X5_C2, X1_C3, X2_C3, X3_C3, X4_C3, X5_C3, X1_C4, X2_C4, X3_C4, X4_C4, X5_C4, X1_C5, X2_C5, X3_C5, X4_C5, X5_C5, X1_C6, X2_C6, X3_C6, X4_C6, X5_C6, X1_C7, X2_C7, X3_C7, X4_C7, X5_C7, X1_C8, X2_C8, X3_C8, X4_C8, X5_C8](
    c: Context8[F]
  )(
    implicit
